...
$table_text = get_option( 'yith_woocompare_table_text', __( 'Compare products', 'gadgeto' ) );
...
<h1>
	...
	if ( ! $is_iframe ) :
		?>
		<a class="close" href="#"><?php esc_html_e( 'X', 'gadgeto' ); ?></a><?php endif; ?>
</h1>
	...
	>
		...
		<?php if ( empty( $products ) ) : ?>
			...
			<tr class="no-products">
				<td><?php esc_html_e( 'No products added in the compare table.', 'gadgeto' ); ?></td>
			</tr>
			...
			<tr class="remove">
				...
				foreach ( $products as $product_id => $product ) :
					...
					<td class="<?php echo esc_attr( $product_class ); ?>">
						...
						?>
						"
								data-product_id="<?php echo esc_attr( $product_id ); ?>"><?php esc_html_e( 'Remove', 'gadgeto' ); ?>
