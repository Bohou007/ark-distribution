...
<form class="hkb-site-search search-form" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label class="hkb-screen-reader-text screen-reader-text" for="s"><?php esc_html_e( 'Search For', 'gadgeto' ); ?></label>
	...
	<?php } ?>
	<button class="hkb-site-search__button search-submit" type="submit"><span><?php esc_html_e( 'Search', 'gadgeto' ); ?></span></button>
	<div class="thebase-search-icon-wrap"><?php thebase()->print_icon( 'search', '', false ); ?></div>
</form>
