...
$settings = array(
	'header_divider3_border' => array(
		...
		'default'      => thebase()->default( 'header_divider3_border' ),
		'live_method'     => array(
			array(
				'type'     => 'css_border',
	...
	'header_divider3_height' => array(
		...
		'default'      => thebase()->default( 'header_divider3_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'%'  => 0,
				'px'  => 0,
	...
	'header_divider3_margin' => array(
		...
		'section'      => 'header_divider3',
		'priority'     => 10,
		'default'      => thebase()->default( 'header_divider3_margin' ),
	...
	'transparent_header_divider3_color' => array(
		...
		'label'        => esc_html__( 'Divider 3 Color', 'gadgeto' ),
		'default'      => thebase()->default( 'transparent_header_divider3_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
