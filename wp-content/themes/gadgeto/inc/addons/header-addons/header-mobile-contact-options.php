...
$settings = array(
	...
	'header_mobile_contact_items' => array(
		...
		'section'      => 'header_mobile_contact',
		'priority'     => 6,
		'default'      => thebase()->default( 'header_mobile_contact_items' ),
		'label'        => esc_html__( 'Contact Items', 'gadgeto' ),
		'partial'      => array(
			'selector'            => '.header-mobile-contact-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'TheBase\header_mobile_contact',
		),
	),
	'header_mobile_contact_item_spacing' => array(
		'control_type' => 'thebase_range_control',
		'section'      => 'header_mobile_contact_design',
		'label'        => esc_html__( 'Item Horizontal Spacing', 'gadgeto' ),
		'default'      => thebase()->default( 'header_mobile_contact_item_spacing' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_mobile_contact_item_vspacing' => array(
		'control_type' => 'thebase_range_control',
		'section'      => 'header_mobile_contact_design',
		'label'        => esc_html__( 'Item Vertical Spacing', 'gadgeto' ),
		'default'      => thebase()->default( 'header_mobile_contact_item_vspacing' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.header-mobile-contact-wrap .element-contact-inner-wrap .header-contact-item',
	...
	'header_mobile_contact_icon_size' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '#mobile-header .element-contact-inner-wrap .header-contact-item .thebase-svg-iconset',
				'property' => 'font-size',
				'pattern'  => '$',
				'key'      => 'size',
			),
		),
		'default'      => thebase()->default( 'header_mobile_contact_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_mobile_contact_color' => array(
		...
		'default'      => thebase()->default( 'header_mobile_contact_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_mobile_contact_link_style' => array(
		...
		'section'      => 'header_mobile_contact_design',
		'default'      => thebase()->default( 'header_mobile_contact_link_style' ),
	...
	'header_mobile_contact_typography' => array(
		...
		'default'      => thebase()->default( 'header_mobile_contact_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '#mobile-header .header-mobile-contact-wrap .header-contact-item',
	...
	'header_mobile_contact_margin' => array(
		...
		'section'      => 'header_mobile_contact_design',
		'priority'     => 10,
		'default'      => thebase()->default( 'header_mobile_contact_margin' ),
	...
	'transparent_header_mobile_contact_color' => array(
		...
		'label'        => esc_html__( 'Contact Colors', 'gadgeto' ),
		'default'      => thebase()->default( 'transparent_header_mobile_contact_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
