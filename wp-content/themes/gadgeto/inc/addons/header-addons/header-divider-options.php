...
$settings = array(
	'header_divider_border' => array(
		...
		'default'      => thebase()->default( 'header_divider_border' ),
		'live_method'     => array(
			array(
				'type'     => 'css_border',
	...
	'header_divider_height' => array(
		...
		'default'      => thebase()->default( 'header_divider_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'%'  => 0,
				'px'  => 0,
	...
	'header_divider_margin' => array(
		...
		'section'      => 'header_divider',
		'priority'     => 10,
		'default'      => thebase()->default( 'header_divider_margin' ),
	...
	'transparent_header_divider_color' => array(
		...
		'label'        => esc_html__( 'Divider Color', 'gadgeto' ),
		'default'      => thebase()->default( 'transparent_header_divider_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
