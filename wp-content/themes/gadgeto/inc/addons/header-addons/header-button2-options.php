...
Theme_Customizer::add_settings(
	array(
		...
		'header_button2_label' => array(
			...
			'default'      => thebase()->default( 'header_button2_label' ),
			'live_method'     => array(
				array(
					'type'     => 'html',
		...
		'header_button2_link' => array(
			...
			'priority'     => 4,
			'default'      => thebase()->default( 'header_button2_link' ),
			'partial'      => array(
				'selector'            => '.header-button2-wrap',
				'container_inclusive' => true,
				'render_callback'     => 'TheBase\header_button2',
			),
		),
		'header_button2_target' => array(
			...
			'section'      => 'header_button2',
			'priority'     => 6,
			'default'      => thebase()->default( 'header_button2_target' ),
		...
		'header_button2_nofollow' => array(
			...
			'section'      => 'header_button2',
			'priority'     => 6,
			'default'      => thebase()->default( 'header_button2_nofollow' ),
		...
		'header_button2_sponsored' => array(
			...
			'section'      => 'header_button2',
			'priority'     => 6,
			'default'      => thebase()->default( 'header_button2_sponsored' ),
		...
		'header_button2_download' => array(
			...
			'section'      => 'header_button2',
			'priority'     => 6,
			'default'      => thebase()->default( 'header_button2_download' ),
			'label'        => esc_html__( 'Set link to Download?', 'gadgeto' ),
		),
		'header_button2_style' => array(
			'control_type' => 'thebase_radio_icon_control',
			'section'      => 'header_button2',
			'priority'     => 6,
			'default'      => thebase()->default( 'header_button2_style' ),
		...
		'header_button2_visibility' => array(
			...
			'section'      => 'header_button2',
			'priority'     => 6,
			'default'      => thebase()->default( 'header_button2_visibility' ),
		...
		'header_button2_size' => array(
			...
			'section'      => 'header_button2_design',
			'priority'     => 4,
			'default'      => thebase()->default( 'header_button2_size' ),
		...
		'header_button2_padding' => array(
			...
			'section'      => 'header_button2_design',
			'priority'     => 10,
			'default'      => thebase()->default( 'header_button2_padding' ),
		...
		'header_button2_color' => array(
			...
			'default'      => thebase()->default( 'header_button2_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#main-header .header-button2',
		...
		'header_button2_background' => array(
			...
			'default'      => thebase()->default( 'header_button2_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#main-header .header-button2',
		...
		'header_button2_border_colors' => array(
			...
			'default'      => thebase()->default( 'header_button2_border' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'header_button2_radius' => array(
			...
			'section'      => 'header_button2_design',
			'priority'     => 10,
			'default'      => thebase()->default( 'header_button2_radius' ),
		...
		'header_button2_typography' => array(
			...
			'default'      => thebase()->default( 'header_button2_typography' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '#main-header .header-button2',
		...
		'header_button2_shadow' => array(
			...
			'section'      => 'header_button2_design',
			'label'        => esc_html__( 'Button Shadow', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'css_boxshadow',
					'selector' => '#main-header .header-button2',
			...
			'default'      => thebase()->default( 'header_button2_shadow' ),
		),
		'header_button2_shadow_hover' => array(
			'control_type' => 'thebase_shadow_control',
			'section'      => 'header_button2_design',
			'label'        => esc_html__( 'Button Hover State Shadow', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'css_boxshadow',
					'selector' => '#main-header .header-button2',
			...
			'default'      => thebase()->default( 'header_button2_shadow_hover' ),
		),
		'header_button2_margin' => array(
			'control_type' => 'thebase_measure_control',
			'section'      => 'header_button2_design',
			'priority'     => 10,
			'default'      => thebase()->default( 'header_button2_margin' ),
		...
		'transparent_header_button2_color' => array(
			...
			'label'        => esc_html__( 'Button2 Colors', 'gadgeto' ),
			'default'      => thebase()->default( 'transparent_header_button2_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'header_sticky_button2_color' => array(
			...
			'label'        => esc_html__( 'Button2 Colors', 'gadgeto' ),
			'default'      => thebase()->default( 'header_sticky_button2_color' ),
			'priority'     => 11,
			'live_method'     => array(
				array(
					'type'     => 'css',
