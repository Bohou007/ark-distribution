...
$settings = array(
	...
	'header_account_preview' => array(
		...
		'label'        => esc_html__( 'Preview/Customize', 'gadgeto' ),
		'transport'    => 'refresh',
		'input_attrs'  => array(
			'layout' => array(
				'in' => array(
					'name' => __( 'Logged in view', 'gadgeto' ),
				),
				'out' => array(
					'name' => __( 'Logged out view', 'gadgeto' ),
				),
			),
			'responsive' => false,
	...
	'info_header_account_logged_out' => array(
		...
		'section'      => 'header_account',
		'label'        => esc_html__( 'Logged Out Options', 'gadgeto' ),
		'settings'     => false,
		'context'      => array(
			array(
	...
	'header_account_style' => array(
		...
		'label'        => esc_html__( 'Account Style', 'gadgeto' ),
		'partial'      => array(
		...
		'input_attrs'  => array(
			'layout' => array(
				'label' => array(
					'name' => __( 'Label', 'gadgeto' ),
				),
				'icon' => array(
					'name' => __( 'Icon', 'gadgeto' ),
				),
				'label_icon' => array(
					'name' => __( 'Label + Icon', 'gadgeto' ),
				),
				'icon_label' => array(
					'name' => __( 'Icon + Label', 'gadgeto' ),
				),
			),
			'responsive' => false,
			'class'      => 'base-two-forced',
	...
	'header_account_label' => array(
		...
		'label'        => esc_html__( 'Account Label', 'gadgeto' ),
		'live_method'     => array(
			array(
				'type'     => 'html',
	...
	'header_account_icon' => array(
		...
		'label'        => esc_html__( 'Account Icon', 'gadgeto' ),
		'partial'      => array(
			'selector'            => '.header-account-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'TheBase\header_account',
	...
	'header_account_action' => array(
		...
		'label'        => esc_html__( 'Account Action', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'    => 'header_account_preview',
		...
		'input_attrs'  => array(
			'layout' => array(
				...
				'dropdown' => array(
					'name' => __( 'Dropdown Menu', 'gadgeto' ),
				),
				'modal' => array(
					'name' => __( 'Modal Login', 'gadgeto' ),
				),
			),
			'responsive' => false,
			'class'      => 'base-two-forced',
	...
	'header_account_dropdown_direction' => array(
		...
		'label'        => esc_html__( 'Dropdown Direction', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'    => 'header_account_preview',
	...
	'header_account_modal_registration' => array(
		...
		'label'        => esc_html__( 'Show registration link below login?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'header_account_modal_registration_link' => array(
		...
		'label'        => esc_html__( 'Registration Link', 'gadgeto' ),
	...
	'header_account_link' => array(
		...
		'section'      => 'header_account',
		'sanitize'     => 'esc_url_raw',
		'label'        => esc_html__( 'Account Item Link', 'gadgeto' ),
	...
	'header_account_color' => array(
		...
		'section'      => 'header_account_design',
		'label'        => esc_html__( 'Account Colors', 'gadgeto' ),
	...
	'header_account_background' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'header_account_design',
		'label'        => esc_html__( 'Account Background', 'gadgeto' ),
	...
	'header_account_typography' => array(
		...
		'section'      => 'header_account_design',
		'label'        => esc_html__( 'Label Font', 'gadgeto' ),
	...
	'info_header_account_logged_in' => array(
		'control_type' => 'thebase_title_control',
		'section'      => 'header_account',
		'label'        => esc_html__( 'Logged In Options', 'gadgeto' ),
		'settings'     => false,
		'context'      => array(
			array(
				'setting'    => 'header_account_preview',
	...
	'header_account_in_style' => array(
		...
		'input_attrs'  => array(
			'layout' => array(
				...
				'user_label' => array(
					'name' => __( 'Avatar + Label', 'gadgeto' ),
				),
				'label_user' => array(
					'name' => __( 'Label + Avatar', 'gadgeto' ),
				),
				'user_name' => array(
					'name' => __( 'Avatar + User Name', 'gadgeto' ),
				),
				'name_user' => array(
					'name' => __( 'User Name + Avatar', 'gadgeto' ),
				),
				'icon_name' => array(
					'name' => __( 'Icon + User Name', 'gadgeto' ),
				),
				'name_icon' => array(
					'name' => __( 'User Name + Icon', 'gadgeto' ),
				),
			),
			'responsive' => false,
			'class'      => 'base-two-forced',
	...
	'header_account_in_dropdown_source' => array(
		...
		'label'        => esc_html__( 'Dropdown Source', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
		...
		'input_attrs'  => array(
			'layout' => array(
				'navigation' => array(
					'name' => __( 'Navigation Menu', 'gadgeto' ),
				),
				'woocommerce' => array(
					'name' => __( 'Woocommerce Account Menu', 'gadgeto' ),
				),
			),
			'responsive' => false,
			'class'      => 'base-two-forced',
	...
	'header_account_in_icon_size' => array(
		'control_type' => 'thebase_range_control',
		'section'      => 'header_account_design',
		'label'        => esc_html__( 'Icon/Image Size', 'gadgeto' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_account_in_image_radius' => array(
		...
		'label'        => esc_html__( 'Avatar Border Radius', 'gadgeto' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.header-account-in-wrap .header-account-avatar',
	...
	'header_account_in_typography' => array(
		'control_type' => 'thebase_typography_control',
		'section'      => 'header_account_design',
		'label'        => esc_html__( 'Label/Name Font', 'gadgeto' ),
	...
	'transparent_header_account_color' => array(
		...
		'label'        => esc_html__( 'Logged out Account Colors', 'gadgeto' ),
	...
	'transparent_header_account_background' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'transparent_header_design',
		'label'        => esc_html__( 'Logged out Account Background', 'gadgeto' ),
	...
	'transparent_header_account_in_color' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'transparent_header_design',
		'label'        => esc_html__( 'Logged in Account Colors', 'gadgeto' ),
	...
	'transparent_header_account_in_background' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'transparent_header_design',
		'label'        => esc_html__( 'Logged in Account Background', 'gadgeto' ),
