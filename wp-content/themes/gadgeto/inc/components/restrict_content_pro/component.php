<?php
/**
 * TheBase\Restrict_Content_Pro\Component class
 *
 * @package thebase
 */

namespace TheBase\Restrict_Content_Pro;
...
class Component implements Component_Interface {
	...
	public function add_styles() {
		wp_enqueue_style( 'thebase-rcp', get_theme_file_uri( '/assets/css/rcp.min.css' ), array(), gadgeto_VERSION );
	}
}
