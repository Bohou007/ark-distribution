<?php
/**
 * TheBase\TutorLMS\Component class
 *
 * @package thebase
 */

namespace TheBase\TutorLMS;
...
class Component implements Component_Interface {
	...
	public function output_inner_content_wrapper_enrolled() {
		...
		if ( 'above' === thebase()->option( 'courses_title_layout' ) ) {
	...
	public function output_course_content_wrapper_enrolled() {
		...
		remove_action( 'thebase_entry_hero', 'TheBase\thebase_entry_header', 10, 2 );
		add_action( 'thebase_entry_hero', array( $this, 'header_lead_enrolled' ), 10, 2 );
		/**
	...
	public function output_course_content_wrapper() {
		thebase()->print_styles( 'thebase-content' );
		remove_action( 'thebase_entry_hero', 'TheBase\thebase_entry_header', 10, 2 );
		add_action( 'thebase_entry_hero', array( $this, 'header_lead' ), 10, 2 );
		/**
		 * Hook for Hero Section
		 */
		do_action( 'thebase_hero_header' );
	...
	public function output_content_wrapper() {
		...
		echo '<div id="primary" class="content-area"><div class="content-container site-container"><main id="main" class="site-main" >';
		if ( is_archive() && thebase()->show_in_content_title() ) {
	...
	public function tutorlms_styles() {
		wp_enqueue_style( 'thebase-tutorlms', get_theme_file_uri( '/assets/css/tutorlms.min.css' ), array(), gadgeto_VERSION );
	}
	/**
	 * Add Defaults
	 *
	...
	public function generate_tutor_css() {
		...
		$css->render_background( thebase()->sub_option( 'courses_title_background', 'desktop' ), $css );
		$css->add_property( 'border-top', $css->render_border( thebase()->sub_option( 'courses_title_top_border', 'desktop' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( thebase()->sub_option( 'courses_title_bottom_border', 'desktop' ) ) );
		$css->set_selector( '.entry-hero.courses-hero-section .entry-header' );
		$css->add_property( 'min-height', $css->render_range( thebase()->option( 'courses_title_height' ), 'desktop' ) );
		$css->set_selector( '.courses-hero-section .hero-section-overlay' );
		$css->add_property( 'background', $css->render_color( thebase()->sub_option( 'courses_title_overlay_color', 'color' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.courses-hero-section .entry-hero-container-inner' );
		$css->render_background( thebase()->sub_option( 'courses_title_background', 'tablet' ), $css );
		$css->add_property( 'border-top', $css->render_border( thebase()->sub_option( 'courses_title_top_border', 'tablet' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( thebase()->sub_option( 'courses_title_bottom_border', 'tablet' ) ) );
		$css->set_selector( '.entry-hero.courses-hero-section .entry-header' );
		$css->add_property( 'min-height', $css->render_range( thebase()->option( 'courses_title_height' ), 'tablet' ) );
		$css->stop_media_query();
		$css->start_media_query( $media_query['mobile'] );
		$css->set_selector( '.courses-hero-section .entry-hero-container-inner' );
		$css->render_background( thebase()->sub_option( 'courses_title_background', 'mobile' ), $css );
		$css->add_property( 'border-top', $css->render_border( thebase()->sub_option( 'courses_title_top_border', 'mobile' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( thebase()->sub_option( 'courses_title_bottom_border', 'mobile' ) ) );
		$css->set_selector( '.entry-hero.courses-hero-section .entry-header' );
		$css->add_property( 'min-height', $css->render_range( thebase()->option( 'courses_title_height' ), 'mobile' ) );
		$css->stop_media_query();
		// Course Title.
		$css->set_selector( '.tutor-single-course-lead-info h1.tutor-course-header-h1' );
		$css->render_font( thebase()->option( 'courses_title_font' ), $css );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.tutor-single-course-lead-info h1.tutor-course-header-h1' );
		$css->add_property( 'font-size', $css->render_font_size( thebase()->option( 'courses_title_font' ), 'tablet' ) );
		$css->add_property( 'line-height', $css->render_font_height( thebase()->option( 'courses_title_font' ), 'tablet' ) );
		$css->add_property( 'letter-spacing', $css->render_font_spacing( thebase()->option( 'courses_title_font' ), 'tablet' ) );
		$css->stop_media_query();
		$css->start_media_query( $media_query['mobile'] );
		$css->set_selector( '.tutor-single-course-lead-info h1.tutor-course-header-h1' );
		$css->add_property( 'font-size', $css->render_font_size( thebase()->option( 'courses_title_font' ), 'mobile' ) );
		$css->add_property( 'line-height', $css->render_font_height( thebase()->option( 'courses_title_font' ), 'mobile' ) );
		$css->add_property( 'letter-spacing', $css->render_font_spacing( thebase()->option( 'courses_title_font' ), 'mobile' ) );
		$css->stop_media_query();
		// Courses Backgrounds.
		$css->set_selector( 'body.post-type-archive-courses .site, body.post-type-archive-courses.content-style-unboxed .site' );
		$css->render_background( thebase()->sub_option( 'courses_archive_content_background', 'desktop' ), $css );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( 'body.post-type-archive-courses .site, body.post-type-archive-courses.content-style-unboxed .site' );
		$css->render_background( thebase()->sub_option( 'courses_archive_content_background', 'tablet' ), $css );
		$css->stop_media_query();
		$css->start_media_query( $media_query['mobile'] );
		$css->set_selector( 'body.post-type-archive-courses .site, body.post-type-archive-courses.content-style-unboxed .site' );
		$css->render_background( thebase()->sub_option( 'courses_archive_content_background', 'mobile' ), $css );
		$css->stop_media_query();
		...
		$css->add_property( 'color', $css->render_color( thebase()->sub_option( 'courses_archive_title_color', 'color' ) ) );
		$css->set_selector( '.courses-archive-title .thebase-breadcrumbs' );
		$css->add_property( 'color', $css->render_color( thebase()->sub_option( 'courses_archive_title_breadcrumb_color', 'color' ) ) );
		$css->set_selector( '.courses-archive-title .thebase-breadcrumbs a:hover' );
		$css->add_property( 'color', $css->render_color( thebase()->sub_option( 'courses_archive_title_breadcrumb_color', 'hover' ) ) );
	...
	public function filter_body_classes( array $classes ) : array {
		if ( is_singular( 'courses' ) ) {
			$classes[] = 'courses-sidebar-overlay-' . ( thebase()->option( 'courses_enroll_overlay' ) ? 'true' : 'false' );
		}
		return $classes;
	}
}
