<?php
/**
 * TheBase\Accessibility\Component class
 *
 * @package thebase
 */

namespace TheBase\Accessibility;
...
class Component implements Component_Interface {
	...
	public function initialize() {
		...
		add_filter( 'thebase_before_header', array( $this, 'skip_to_content_link' ), 2 );
	}
	...
	public function skip_to_content_link() {
		?>
		<a class="skip-link screen-reader-text scroll-ignore" href="#main"><?php esc_html_e( 'Skip to content', 'gadgeto' ); ?></a>
		<?php
	}
