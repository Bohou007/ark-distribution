<?php
/**
 * TheBase\Icons\Component class
 *
 * @package thebase
 */

namespace TheBase\Icons;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		$display_title = apply_filters( 'thebase_svg_icons_have_title', true );
		$output = '<span class="thebase-svg-iconset' . ( $base ? ' svg-baseline' : '' ) . '">';
		switch ( $icon ) {
			case 'moon':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-moon-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
				</svg>';
				break;
			case 'moonAlt':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-moon-alt-svg" fill="currentColor" version="1.1" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'sun':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-sun-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'sunAlt':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-sun-alt-svg" fill="currentColor" version="1.1" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'sunrise':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-sunrise-svg" fill="currentColor" version="1.1" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'sunset':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-sunset-svg" fill="currentColor" version="1.1" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'settings':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-settings-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Settings', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'home':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-home-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Home', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M9.984 20.016h-4.969v-8.016h-3l9.984-9 9.984 9h-3v8.016h-4.969v-6h-4.031v6z"></path>
				</svg>';
				break;
			case 'search':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-search-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'search2':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-search2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'zoom':
				$output .= '<svg class="thebase-svg-icon thebase-zoom-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Zoom In', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M18 13c0-3.859-3.141-7-7-7s-7 3.141-7 7 3.141 7 7 7 7-3.141 7-7zM26 26c0 1.094-0.906 2-2 2-0.531 0-1.047-0.219-1.406-0.594l-5.359-5.344c-1.828 1.266-4.016 1.937-6.234 1.937-6.078 0-11-4.922-11-11s4.922-11 11-11 11 4.922 11 11c0 2.219-0.672 4.406-1.937 6.234l5.359 5.359c0.359 0.359 0.578 0.875 0.578 1.406z"></path>
				</svg>';
				break;
			case 'bag':
				$output .= '<svg class="thebase-svg-icon thebase-bag-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bag', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'facebook':
				$output .= '<svg class="thebase-svg-icon thebase-facebook-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'facebookAlt':
				$output .= '<svg class="thebase-svg-icon thebase-facebook-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'facebookAlt2':
				$output .= '<svg class="thebase-svg-icon thebase-facebook-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="28" viewBox="0 0 16 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'twitter':
				$output .= '<svg class="thebase-svg-icon thebase-twitter-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'twitterAlt':
				$output .= '<svg class="thebase-svg-icon thebase-twitter-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'tiktok':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-tiktok-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'TikTok', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'discord':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-discord-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discord', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'instagram':
				$output .= '<svg class="thebase-svg-icon thebase-instagram-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'instagramAlt':
				$output .= '<svg class="thebase-svg-icon thebase-instagram-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'vimeo':
				$output .= '<svg class="thebase-svg-icon thebase-vimeo-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Vimeo', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'youtube':
				$output .= '<svg class="thebase-svg-icon thebase-youtube-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'youtubeAlt':
				$output .= '<svg class="thebase-svg-icon thebase-youtube-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'github':
				$output .= '<svg class="thebase-svg-icon thebase-github-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'githubAlt':
				$output .= '<svg class="thebase-svg-icon thebase-github-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'rss':
				$output .= '<svg class="thebase-svg-icon thebase-rss-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'rssAlt':
				$output .= '<svg class="thebase-svg-icon thebase-rss-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'facebook_group':
				$output .= '<svg class="thebase-svg-icon thebase-facebook-group-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="30" height="28" viewBox="0 0 30 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook Group', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'dribbble':
				$output .= '<svg class="thebase-svg-icon thebase-dribbble-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dribbble', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'xing':
				$output .= '<svg class="thebase-svg-icon thebase-xing-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="28" viewBox="0 0 22 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Xing', 'gadgeto' ) ) . '</title>';
				}
			...
			case 'wordpress': // phpcs:ignore WordPress.WP.CapitalPDangit.Misspelled
				$output .= '<svg class="thebase-svg-icon thebase-wordpress-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WordPress', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'whatsapp':
				$output .= '<svg class="thebase-svg-icon thebase-whatsapp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WhatsApp', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'vk':
				$output .= '<svg class="thebase-svg-icon thebase-vk-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'VK', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'tumblr':
				$output .= '<svg class="thebase-svg-icon thebase-tumblr-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="17" height="28" viewBox="0 0 17 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Tumblr', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M14.75 20.766l1.25 3.703c-0.469 0.703-2.594 1.5-4.5 1.531-5.672 0.094-7.812-4.031-7.812-6.937v-8.5h-2.625v-3.359c3.938-1.422 4.891-4.984 5.109-7.016 0.016-0.125 0.125-0.187 0.187-0.187h3.813v6.625h5.203v3.937h-5.219v8.094c0 1.094 0.406 2.609 2.5 2.562 0.688-0.016 1.609-0.219 2.094-0.453z"></path>
				</svg>';
				break;
			case 'reddit':
				$output .= '<svg class="thebase-svg-icon thebase-reddit-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'redditAlt':
				$output .= '<svg class="thebase-svg-icon thebase-reddit-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'patreon':
				$output .= '<svg class="thebase-svg-icon thebase-patreon-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Patreon', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'medium':
				$output .= '<svg class="thebase-svg-icon thebase-medium-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Medium', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'behance':
				$output .= '<svg class="thebase-svg-icon thebase-behance-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 32 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Behance', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'anchor':
				$output .= '<svg class="thebase-svg-icon thebase-anchor-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Anchor', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'soundcloud':
				$output .= '<svg class="thebase-svg-icon thebase-soundcloud-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'soundcloudAlt':
				$output .= '<svg class="thebase-svg-icon thebase-soundcloud-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'email':
				$output .= '<svg class="thebase-svg-icon thebase-email-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'emailAlt':
				$output .= '<svg class="thebase-svg-icon thebase-email-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'emailAlt2':
				$output .= '<svg class="thebase-svg-icon thebase-email-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'phone':
				$output .= '<svg class="thebase-svg-icon thebase-phone-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="12" height="28" viewBox="0 0 12 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M7.25 22c0-0.688-0.562-1.25-1.25-1.25s-1.25 0.562-1.25 1.25 0.562 1.25 1.25 1.25 1.25-0.562 1.25-1.25zM10.5 19.5v-11c0-0.266-0.234-0.5-0.5-0.5h-8c-0.266 0-0.5 0.234-0.5 0.5v11c0 0.266 0.234 0.5 0.5 0.5h8c0.266 0 0.5-0.234 0.5-0.5zM7.5 6.25c0-0.141-0.109-0.25-0.25-0.25h-2.5c-0.141 0-0.25 0.109-0.25 0.25s0.109 0.25 0.25 0.25h2.5c0.141 0 0.25-0.109 0.25-0.25zM12 6v16c0 1.094-0.906 2-2 2h-8c-1.094 0-2-0.906-2-2v-16c0-1.094 0.906-2 2-2h8c1.094 0 2 0.906 2 2z"></path>
				</svg>';
				break;
			case 'phoneAlt':
				$output .= '<svg class="thebase-svg-icon thebase-phone-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'phoneAlt2':
				$output .= '<svg class="thebase-svg-icon thebase-phone-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'google_reviews':
				$output .= '<svg class="thebase-svg-icon thebase-google-reviews-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Google Reviews', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'telegram':
				$output .= '<svg class="thebase-svg-icon thebase-telegram-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'telegramAlt':
				$output .= '<svg class="thebase-svg-icon thebase-telegram-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'trip_advisor':
				$output .= '<svg class="thebase-svg-icon thebase-trip-advisor-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="36" height="28" viewBox="0 0 36 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Trip Advisor', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'yelp':
				$output .= '<svg class="thebase-svg-icon thebase-yelp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Yelp', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'user':
				$output .= '<svg class="thebase-svg-icon thebase-user-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'User', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'comments':
				$output .= '<svg class="thebase-svg-icon thebase-comments-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'commentsAlt':
				$output .= '<svg class="thebase-svg-icon thebase-comments-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'folder':
				$output .= '<svg class="thebase-svg-icon thebase-comments-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Categories', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'grid':
				$output .= '<svg class="thebase-svg-icon thebase-grid-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Grid', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'gridlarge':
				$output .= '<svg class="thebase-svg-icon thebase-gridlarge-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Grid', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'list':
				$output .= '<svg class="thebase-svg-icon thebase-list-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'List', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M1 3h14v3h-14zM1 7h14v3h-14zM1 11h14v3h-14z"></path>
				</svg>';
				break;
			case 'account':
				$output .= '<svg class="thebase-svg-icon thebase-account-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 477.12 512">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M238.56,288.39C84.72,288.39,0,361.17,0,493.31A18.68,18.68,0,0,0,18.67,512H458.43a18.69,18.69,0,0,0,18.69-18.69h0C477.12,361.17,392.4,288.39,238.56,288.39ZM38.05,474.63c7.35-98.81,74.71-148.87,200.51-148.87s193.16,50.06,200.52,148.87Z" transform="translate(0)"/><path d="M238.56,0C167.89,0,114.61,54.36,114.61,126.44c0,74.19,55.6,134.54,124,134.54s124-60.35,124-134.54C362.51,54.36,309.23,0,238.56,0Zm0,223.61C190.82,223.61,152,180,152,126.44c0-51.61,36.41-89.07,86.58-89.07,49.36,0,86.58,38.29,86.58,89.07C325.14,180,286.3,223.61,238.56,223.61Z" transform="translate(0)"></path>
				</svg>';
				break;
			case 'account2':
				$output .= '<svg class="thebase-svg-icon thebase-account2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'account3':
				$output .= '<svg class="thebase-svg-icon thebase-account3-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'gadgeto' ) ) . '</title>';
				}
				...
				break;	
			case 'feed':
				$output .= '<svg class="thebase-svg-icon thebase-feed-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="28" viewBox="0 0 22 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'pinterest':
				$output .= '<svg class="thebase-svg-icon thebase-pinterest-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'pinterestAlt':
				$output .= '<svg class="thebase-svg-icon thebase-pinterest-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'mobile':
				$output .= '<svg class="thebase-svg-icon thebase-mobile-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="12" height="28" viewBox="0 0 12 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Mobile', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M7.25 22c0-0.688-0.562-1.25-1.25-1.25s-1.25 0.562-1.25 1.25 0.562 1.25 1.25 1.25 1.25-0.562 1.25-1.25zM10.5 19.5v-11c0-0.266-0.234-0.5-0.5-0.5h-8c-0.266 0-0.5 0.234-0.5 0.5v11c0 0.266 0.234 0.5 0.5 0.5h8c0.266 0 0.5-0.234 0.5-0.5zM7.5 6.25c0-0.141-0.109-0.25-0.25-0.25h-2.5c-0.141 0-0.25 0.109-0.25 0.25s0.109 0.25 0.25 0.25h2.5c0.141 0 0.25-0.109 0.25-0.25zM12 6v16c0 1.094-0.906 2-2 2h-8c-1.094 0-2-0.906-2-2v-16c0-1.094 0.906-2 2-2h8c1.094 0 2 0.906 2 2z"></path>
				</svg>';
				break;
			case 'hours':
				$output .= '<svg class="thebase-svg-icon thebase-hours-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'hoursAlt':
				$output .= '<svg class="thebase-svg-icon thebase-hours-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'hoursAlt2':
				$output .= '<svg class="thebase-svg-icon thebase-hours-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'location':
				$output .= '<svg class="thebase-svg-icon thebase-location-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="28" viewBox="0 0 16 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'locationAlt':
				$output .= '<svg class="thebase-svg-icon thebase-location-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'locationAlt2':
				$output .= '<svg class="thebase-svg-icon thebase-location-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'envelop':
				$output .= '<svg class="thebase-svg-icon thebase-envelop-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Envelop', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'linkedin':
				$output .= '<svg class="thebase-svg-icon thebase-linkedin-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'linkedinAlt':
				$output .= '<svg class="thebase-svg-icon thebase-linkedin-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'goodreads':
				$output .= '<svg class="thebase-svg-icon thebase-goodreads-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Goodreads', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'amazon':
				$output .= '<svg class="thebase-svg-icon thebase-amazon-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Amazon', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'bookbub':
				$output .= '<svg class="thebase-svg-icon thebase-bookbub-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'BookBub', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'quotes':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-quotes-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Quotes', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-left':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-arrow-left-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-right':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-arrow-right-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Next', 'gadgeto' ) ) . '</title>';
				}
			...
			case 'arrow-right-alt':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-arrow-right-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="27" height="28" viewBox="0 0 27 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Continue', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M27 13.953c0 0.141-0.063 0.281-0.156 0.375l-6 5.531c-0.156 0.141-0.359 0.172-0.547 0.094-0.172-0.078-0.297-0.25-0.297-0.453v-3.5h-19.5c-0.281 0-0.5-0.219-0.5-0.5v-3c0-0.281 0.219-0.5 0.5-0.5h19.5v-3.5c0-0.203 0.109-0.375 0.297-0.453s0.391-0.047 0.547 0.078l6 5.469c0.094 0.094 0.156 0.219 0.156 0.359v0z"></path>
				</svg>';
				break;
			case 'arrow-left-alt':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-arrow-left-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="29" height="28" viewBox="0 0 29 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-down':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-arrow-down-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Expand', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-up':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-arrow-up-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-up2':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-arrow-up2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'chevron-up':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-chevron-up-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'chevron-up2':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-chevron-up2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'menu':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-menu-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 980 723.03">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M10,190.13v51.64H990V138.48H10Z" transform="translate(-10 -138.48)"/><path d="M10,500v51.65H629.74V448.35H10Z" transform="translate(-10 -138.48)"/><path d="M10,809.87v51.64l400.06-.5,399.81-.76.76-51.14.5-50.89H10Z" transform="translate(-10 -138.48)"></path>
				</svg>';
				break;
			case 'menu2':
				$output .= '<svg class="thebase-svg-icon thebase-menu2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'menu3':
				$output .= '<svg class="thebase-svg-icon thebase-menu3-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'listFilter':
				$output .= '<svg class="thebase-svg-icon thebase-list-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'listFilterAlt':
				$output .= '<svg class="thebase-svg-icon thebase-list-filter-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'close':
				$output .= '<svg class="thebase-svg-icon thebase-close-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'closeAlt':
				$output .= '<svg class="thebase-svg-icon thebase-close-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'closeAlt2':
				$output .= '<svg class="thebase-svg-icon thebase-close-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'shopping-bag':
				$output .= '<svg class="thebase-svg-icon thebase-shopping-bag-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 980 982.8">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M816.5,991.4H206.9c-51.1,0-79.8-68.1-81.9-106.9L10.8,374.9a33,33,0,0,1-.8-7.7c0-44.4,36-79.1,82.1-79.1H908c46,0,82,34.7,82,79.1l-92.1,519C898.5,917.9,869.6,991.4,816.5,991.4ZM80.7,364.8,194.4,872.4a33,33,0,0,1,.8,7.7c0,13.4,11,37.8,17.8,42.5l599.1-1.4c6.8-7,16.1-28.6,16.1-41l92.1-519c-.6-2.2-10.4-2.6-12.3-2.6H92.1C90.3,358.5,82.4,358.8,80.7,364.8Z" transform="translate(-10 -8.6)"/><path d="M750.8,246.8a35.25,35.25,0,0,1-35.2-35.2c0-88.1-71.4-132.7-212.2-132.7S291.3,123.6,291.3,211.6a35.2,35.2,0,1,1-70.4,0c0-129,103-203,282.5-203s282.5,74,282.5,203A35,35,0,0,1,750.8,246.8Z" transform="translate(-10 -8.6)"/>
				</svg>';
				break;
			case 'shopping-cart':
				$output .= '<svg class="thebase-svg-icon thebase-shopping-cart-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 762.47 673.5">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M600.86,489.86a91.82,91.82,0,1,0,91.82,91.82A91.81,91.81,0,0,0,600.86,489.86Zm0,142.93a51.12,51.12,0,1,1,51.11-51.11A51.12,51.12,0,0,1,600.82,632.79Z"/><path d="M303.75,489.86a91.82,91.82,0,1,0,91.82,91.82A91.82,91.82,0,0,0,303.75,489.86Zm-.05,142.93a51.12,51.12,0,1,1,51.12-51.11A51.11,51.11,0,0,1,303.7,632.79Z"/><path d="M392.07,561.33h66.55a20.52,20.52,0,0,1,20.46,20.46h0a20.52,20.52,0,0,1-20.46,20.46H392.07"/><path d="M698.19,451.14H205.93a23.11,23.11,0,0,1-23.09-22c0-.86-.09-1.72-.19-2.57l-1.82-16.36H723.51L721.3,428A23.11,23.11,0,0,1,698.19,451.14Z"/><path d="M759.15,153.79H246.94l-3.32-24.38a17.25,17.25,0,0,1,17.25-17.26H745.21a17.26,17.26,0,0,1,17.26,17.26Z"/><path d="M271.55,345.56l-31.16-208A20.53,20.53,0,0,1,257.13,114h0a20.53,20.53,0,0,1,23.6,16.74l31.16,208a20.52,20.52,0,0,1-16.74,23.59h0A20.52,20.52,0,0,1,271.55,345.56Z"/><path d="M676,451.15l48.69-337.74,22.9.07a17.25,17.25,0,0,1,14.55,19.59l-42.1,303.16a17.24,17.24,0,0,1-19.59,14.54Z"/><path d="M184.24,436.27,123.7.12l23.72,0a17.26,17.26,0,0,1,19.33,14.92l60.56,436.35-23.74-.25A17.25,17.25,0,0,1,184.24,436.27Z"/><path d="M148.38,40.77H20.26A20.32,20.32,0,0,1,0,20.51H0A20.32,20.32,0,0,1,20.26.25H148.38"></path>
				</svg>';
				break;
			case 'apple_podcasts':
				$output .= '<svg class="thebase-svg-icon thebase-apple-podcasts-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Podcasts', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'spotify':
				$output .= '<svg class="thebase-svg-icon thebase-spotify-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Spotify', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'flickr':
				$output .= '<svg class="thebase-svg-icon thebase-flicker-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Flicker', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case '500px':
				$output .= '<svg class="thebase-svg-icon thebase-500px-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( '500PX', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'bandcamp':
				$output .= '<svg class="thebase-svg-icon thebase-bandcamp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bandcamp', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M0 18.75l7.437-13.5H24l-7.438 13.5H0z" />
				</svg>';
				break;
			case 'imdb':
				$output .= '<svg class="thebase-svg-icon thebase-imdb-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'IMDB', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'spinner':
				$output .= '<svg class="thebase-svg-icon thebase-spinner-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Loading', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'check':
				$output .= '<svg class="thebase-svg-icon thebase-check-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Done', 'gadgeto' ) ) . '</title>';
				}
				$output .= '<path d="M14 2.5l-8.5 8.5-3.5-3.5-1.5 1.5 5 5 10-10z"></path>
				</svg>';
				break;
			case 'checkbox':
				$output .= '<svg class="thebase-svg-icon thebase-checkbox-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'gadgeto' ) ) . '</title>';
				}
				...
				break;
			case 'checkbox_alt':
				$output .= '<svg class="thebase-svg-icon thebase-checkbox-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'gadgeto' ) ) . '</title>';
				}
			...
			case 'shield_check':
				...
				break;
			case 'disc':
				$output .= '<svg class="thebase-svg-icon thebase-disc-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Disc', 'gadgeto' ) ) . '</title>';
				}
		...
		$output = apply_filters( 'thebase_svg_icon', $output, $icon, $icon_title, $base );
	...
	public function print_icon( $icon = 'search', $icon_title = '', $base = true ) {
		echo html_entity_decode( esc_html($this->get_icon( $icon, $icon_title, $base))); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}
