	...
	public function color_palette_register( $wp_customize ) {
		...
		$wp_customize->add_control(
			new TheBase_Control_Color_Palette(
				...
				array(
					'label'       => __( 'Global Palette', 'gadgeto' ),
					'description' => __( 'Learn how to use this', 'gadgeto' ),
