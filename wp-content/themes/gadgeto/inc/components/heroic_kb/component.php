<?php
/**
 * TheBase\Heroic_Kb\Component class
 *
 * @package thebase
 */

namespace TheBase\Heroic_Kb;
...
class Component implements Component_Interface {
	...
	public function initialize() {
		...
		add_action( 'thebase_entry_archive_hero', array( $this, 'ht_knowledge_base_breadcrumb_in_title' ), 5 );
		add_action( 'thebase_entry_archive_header', array( $this, 'ht_knowledge_base_breadcrumb_in_title' ), 5 );
		//add_action( 'thebase_entry_header', array( $this, 'ht_knowledge_base_breadcrumb_in_title' ), 5 );
		add_action( 'thebase_entry_archive_hero', array( $this, 'ht_knowledge_base_search_in_title' ), 20 );
		add_action( 'thebase_entry_archive_header', array( $this, 'ht_knowledge_base_search_in_title' ), 20 );
		add_action( 'thebase_entry_header', array( $this, 'ht_knowledge_base_search_in_title' ), 20 );
	}
	/**
