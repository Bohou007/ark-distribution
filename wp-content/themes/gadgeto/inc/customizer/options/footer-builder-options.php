...
<span class="button button-secondary thebase-builder-show-button thebase-builder-tab-toggle"><span class="dashicons dashicons-edit"></span><?php esc_html_e( 'Footer Builder', 'gadgeto' ); ?></span>
<?php
...
$settings = array(
	...
	'footer_items' => array(
		...
		'choices'      => array(
			'footer-navigation'          => array(
				'name'    => esc_html__( 'Footer Navigation', 'gadgeto' ),
		...
		'input_attrs'  => array(
			...
			'zones' => array(
				'top' => array(
					'top_1' => esc_html__( 'Top - 1', 'gadgeto' ),
					'top_2' => esc_html__( 'Top - 2', 'gadgeto' ),
					'top_3' => esc_html__( 'Top - 3', 'gadgeto' ),
					'top_4' => esc_html__( 'Top - 4', 'gadgeto' ),
					'top_5' => esc_html__( 'Top - 5', 'gadgeto' ),
				),
				'middle' => array(
					'middle_1' => esc_html__( 'Middle - 1', 'gadgeto' ),
					'middle_2' => esc_html__( 'Middle - 2', 'gadgeto' ),
					'middle_3' => esc_html__( 'Middle - 3', 'gadgeto' ),
					'middle_4' => esc_html__( 'Middle - 4', 'gadgeto' ),
					'middle_5' => esc_html__( 'Middle - 5', 'gadgeto' ),
				),
				'bottom' => array(
					'bottom_1' => esc_html__( 'Bottom - 1', 'gadgeto' ),
					'bottom_2' => esc_html__( 'Bottom - 2', 'gadgeto' ),
					'bottom_3' => esc_html__( 'Bottom - 3', 'gadgeto' ),
					'bottom_4' => esc_html__( 'Bottom - 4', 'gadgeto' ),
					'bottom_5' => esc_html__( 'Bottom - 5', 'gadgeto' ),
				),
			),
		),
	),
	...
	'footer_wrap_background' => array(
		...
		'section'      => 'footer_layout',
		'label'        => esc_html__( 'Footer Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Footer Background', 'gadgeto' ),
		),
	),
	'enable_footer_on_bottom' => array(
		...
		'label'        => esc_html__( 'Keep footer on bottom of screen', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting' => '__current_tab',
