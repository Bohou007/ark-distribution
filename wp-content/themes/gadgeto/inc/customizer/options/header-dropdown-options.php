...
Theme_Customizer::add_settings(
	array(
		...
		'dropdown_navigation_color' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'label'        => esc_html__( 'Dropdown Colors', 'gadgeto' ),
		...
		'dropdown_navigation_background' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Background', 'gadgeto' ),
		...
		'dropdown_navigation_typography' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Font', 'gadgeto' ),
		...
		'dropdown_navigation_shadow' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Shadow', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'css_boxshadow',
		...
		'dropdown_navigation_reveal' => array(
			...
			'label'        => esc_html__( 'Dropdown Reveal', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
			...
			'input_attrs'  => array(
				'layout' => array(
					...
					'fade-up' => array(
						'name'    => __( 'Fade Up', 'gadgeto' ),
					),
					'fade-down' => array(
						'name'    => __( 'Fade Down', 'gadgeto' ),
					),
				),
				'responsive' => false,
			),
		...
		'dropdown_navigation_width' => array(
			...
			'section'      => 'dropdown_navigation',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Width', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'dropdown_navigation_vertical_spacing' => array(
			...
			'section'      => 'dropdown_navigation',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Items Vertical Spacing', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.header-navigation .header-menu-container ul ul li.menu-item > a',
