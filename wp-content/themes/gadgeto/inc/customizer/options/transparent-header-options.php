...
$thebase_trans_settings = array(
	...
	'transparent_header_enable' => array(
		...
		'label'        => esc_html__( 'Enable Transparent Header?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'transparent_header_archive' => array(
		...
		'label'        => esc_html__( 'Disable Search and Archives?', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'transparent_header_page' => array(
		...
		'label'        => esc_html__( 'Disable on Pages?', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'transparent_header_enable',
	...
	'transparent_header_post' => array(
		...
		'label'        => esc_html__( 'Disable on Posts?', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'transparent_header_enable',
	...
	'transparent_header_device' => array(
		...
		'label'        => esc_html__( 'Enable for:', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'  => 'transparent_header_enable',
				'operator' => '=',
		...
		'input_attrs'  => array(
			'options' => array(
				'desktop' => array(
					'name' => __( 'Desktop', 'gadgeto' ),
					'icon' => 'desktop',
				),
				'mobile' => array(
					'name' => __( 'Mobile', 'gadgeto' ),
					'icon' => 'smartphone',
				),
			),
		),
	...
	'transparent_header_custom_logo' => array(
		...
		'label'        => esc_html__( 'Different Logo for Transparent Header?', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
	...
	'transparent_header_logo' => array(
		...
		'mime_type'    => 'image',
		'default'      => '',
		'label'        => esc_html__( 'Transparent Header Logo', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'transparent_header_background' => array(
		...
		'section'      => 'transparent_header_design',
		'label'        => esc_html__( 'Transparent Header Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Transparent Header Background', 'gadgeto' ),
		),
	),
	...
	$thebase_trans_settings = array_merge(
		...
		array(
			'transparent_header_product' => array(
				...
				'label'        => esc_html__( 'Disable on Products?', 'gadgeto' ),
				'transport'    => 'refresh',
				'context'      => array(
					array(
						'setting'  => 'transparent_header_enable',
...
foreach ( $thebase_trans_post_types as $post_type_item ) {
	...
	if ( ! in_array( $post_type_name, $ignore_type, true ) ) {
		...
		$thebase_trans_extras_post_types[ 'transparent_header_' . $post_type_name ] = array(
			...
			'priority'     => 5,
			'default'      => true,
			'label'        => esc_html__( 'Disable on', 'gadgeto' ) . ' ' . $post_type_label . '?',
			'transport'    => 'refresh',
			'context'      => array(
				array(
					'setting'  => 'transparent_header_enable',
