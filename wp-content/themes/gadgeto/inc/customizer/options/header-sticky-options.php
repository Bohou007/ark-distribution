...
$settings = array(
	...
	'header_sticky' => array(
		...
		'label'        => esc_html__( 'Enable Sticky Header?', 'gadgeto' ),
		'input_attrs'  => array(
			'options' => array(
				'no' => array(
					'name' => __( 'No', 'gadgeto' ),
				...
				'main' => array(
					'name' => __( 'Yes - Only Main Row', 'gadgeto' ),
				),
				'top_main' => array(
					'name' => __( 'Yes - Top Row & Main Row', 'gadgeto' ),
				),
				'top_main_bottom' => array(
					'name' => __( 'Yes - Whole Header', 'gadgeto' ),
				),
				'top' => array(
					'name' => __( 'Yes - Only Top Row', 'gadgeto' ),
				),
				'bottom' => array(
					'name' => __( 'Yes - Only Bottom Row', 'gadgeto' ),
				),
			),
		),
	),
	'header_reveal_scroll_up' => array(
		...
		'label'        => esc_html__( 'Enable Reveal Sticky on Scroll up', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'header_sticky_shrink' => array(
		...
		'label'        => esc_html__( 'Enable Main Row Shrinking', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'header_sticky',
	...
	'header_sticky_main_shrink' => array(
		...
		'section'      => 'header_sticky',
		'label'        => esc_html__( 'Main Row Shrink Height', 'gadgeto' ),
		'context'      => array(
			array(
	...
	'header_sticky_custom_logo' => array(
		...
		'label'        => esc_html__( 'Different Logo for Stuck Header?', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
	...
	'header_sticky_logo' => array(
		...
		'mime_type'    => 'image',
		'default'      => '',
		'label'        => esc_html__( 'Stuck Header Logo', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'header_sticky_logo_width' => array(
		'control_type' => 'thebase_range_control',
		'section'      => 'header_sticky',
		'label'        => esc_html__( 'Logo Max Width', 'gadgeto' ),
		'description'  => esc_html__( 'Define the maxium width for the logo', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'  => 'header_sticky',
				'operator' => '!=',
	...
	'info_mobile_header_sticky' => array(
		...
		'section'      => 'header_sticky',
		'priority'     => 20,
		'label'        => esc_html__( 'Mobile Sticky', 'gadgeto' ),
		'settings'     => false,
	),
	'mobile_header_sticky' => array(
		...
		'label'        => esc_html__( 'Enable Sticky for Mobile?', 'gadgeto' ),
		'input_attrs'  => array(
			'options' => array(
				'no' => array(
					'name' => __( 'No', 'gadgeto' ),
	...
	'mobile_header_sticky_shrink' => array(
		...
		'label'        => esc_html__( 'Enabled Main Row Shrinking', 'gadgeto' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'mobile_header_sticky',
	...
	'header_sticky_custom_mobile_logo' => array(
		...
		'label'        => esc_html__( 'Different Logo for Mobile?', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'header_sticky_mobile_logo' => array(
		...
		'mime_type'    => 'image',
		'default'      => '',
		'label'        => esc_html__( 'Mobile Logo', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'header_sticky_site_title_color' => array(
		...
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Site Title Color', 'gadgeto' ),
	...
	'header_sticky_navigation_background' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Navigation Items Background', 'gadgeto' ),
	...
	'header_sticky_button_color' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Button Colors', 'gadgeto' ),
	...
	'header_sticky_social_color' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Social Colors', 'gadgeto' ),
	...
	'header_sticky_html_color' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'HTML Colors', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'link' => array(
					'tooltip' => __( 'Link Color', 'gadgeto' ),
					'palette' => true,
				),
				'hover' => array(
					'tooltip' => __( 'Link Hover', 'gadgeto' ),
					'palette' => true,
				),
			),
		),
	...
	'header_sticky_background' => array(
		...
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Sticky Header Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Sticky Header Background', 'gadgeto' ),
		),
	),
	'header_sticky_bottom_border' => array(
		'control_type' => 'thebase_border_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Sticky Bottom Border', 'gadgeto' ),
