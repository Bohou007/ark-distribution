...
Theme_Customizer::add_settings(
	array(
		...
		'sidebar_width' => array(
			...
			'section'      => 'sidebar',
			'priority'     => 10,
			'label'        => esc_html__( 'Sidebar Width', 'gadgeto' ),
			// 'context'      => array(
			// 	array(
			...
			'default'      => thebase()->default( 'sidebar_width' ),
			'input_attrs'  => array(
				'min'        => array(
					'px'  => 100,
					'em'  => 8,
		...
		'sidebar_widget_spacing' => array(
			...
			'default'      => thebase()->default( 'sidebar_widget_spacing' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 0,
					'em'  => 0,
		...
		'sidebar_widget_title' => array(
			...
			// 	),
			// ),
			'default'      => thebase()->default( 'sidebar_widget_title' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
		...
		'sidebar_widget_content' => array(
			...
			// 	),
			// ),
			'default'      => thebase()->default( 'sidebar_widget_content' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '.primary-sidebar.widget-area .widget',
		...
		'sidebar_link_style' => array(
			...
			'section'      => 'sidebar_design',
			'default'      => thebase()->default( 'sidebar_link_style' ),
		...
		'sidebar_link_colors' => array(
			...
			'default'      => thebase()->default( 'sidebar_link_colors' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'sidebar_background' => array(
			...
			'section'      => 'sidebar_design',
			'label'        => esc_html__( 'Sidebar Background', 'gadgeto' ),
			'default'      => thebase()->default( 'sidebar_background' ),
			// 'context'      => array(
			// 	array(
			// 		'setting' => '__current_tab',
			// 		'value'   => 'design',
			...
			'input_attrs'  => array(
				'tooltip'  => __( 'Sidebar Background', 'gadgeto' ),
			),
		),
		'sidebar_divider_border' => array(
			'control_type' => 'thebase_border_control',
			'section'      => 'sidebar_design',
			'label'        => esc_html__( 'Sidebar Divider Border', 'gadgeto' ),
			'default'      => thebase()->default( 'sidebar_divider_border' ),
			// 'context'      => array(
			// 	array(
			// 		'setting' => '__current_tab',
			// 		'value'   => 'design',
		...
		'sidebar_padding' => array(
			...
			'section'      => 'sidebar_design',
			'priority'     => 10,
			'default'      => thebase()->default( 'sidebar_padding' ),
			'label'        => esc_html__( 'Sidebar Padding', 'gadgeto' ),
			// 'context'      => array(
			// 	array(
			// 		'setting' => '__current_tab',
			// 		'value'   => 'design',
		...
		'sidebar_sticky' => array(
			...
			'section'      => 'sidebar',
			'default'      => thebase()->default( 'sidebar_sticky' ),
			'label'        => esc_html__( 'Enable Sticky Sidebar', 'gadgeto' ),
			'transport'    => 'refresh',
		),
		'sidebar_sticky_last_widget' => array(
			...
			'sanitize'     => 'thebase_sanitize_toggle',
			'section'      => 'sidebar',
			'default'      => thebase()->default( 'sidebar_sticky_last_widget' ),
			'label'        => esc_html__( 'Only Stick Last Widget', 'gadgeto' ),
			'transport'    => 'refresh',
			'context'      => array(
				array(
