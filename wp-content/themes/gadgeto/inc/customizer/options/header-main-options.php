...
$settings = array(
	...
	'header_main_background' => array(
		...
		'section'      => 'header_main',
		'label'        => esc_html__( 'Main Row Background', 'gadgeto' ),
	...
	'header_main_trans_background' => array(
		'control_type' => 'thebase_background_control',
		'section'      => 'header_main',
		'label'        => esc_html__( '(When Transparent Header) Main Row Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Transparent Header Main Row Background', 'gadgeto' ),
		),
	),
);
