...
$settings = array(
	...
	'info_search_archive_title' => array(
		...
		'section'      => 'search',
		'priority'     => 2,
		'label'        => esc_html__( 'Search Results Title', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'search_archive_title' => array(
		...
		'label'        => esc_html__( 'Show Search Results Title?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'search_archive_title_layout' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'search',
		'label'        => esc_html__( 'Search Results Title Layout', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 4,
	...
	'search_archive_title_align' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'search',
		'label'        => esc_html__( 'Search Results Title Align', 'gadgeto' ),
		'priority'     => 4,
	...
	'search_archive_columns' => array(
		...
		'section'      => 'search',
		'priority'     => 10,
		'label'        => esc_html__( 'Search Result Columns', 'gadgeto' ),
		'transport'    => 'refresh',
	...
	'info_search_archive_item_layout' => array(
		...
		'section'      => 'search',
		'priority'     => 12,
		'label'        => esc_html__( 'Search Item Layout', 'gadgeto' ),
		'settings'     => false,
	),
	'search_archive_elements' => array(
		...
		'label'        => esc_html__( 'Search Item Elements', 'gadgeto' ),
		'transport'    => 'refresh',
		'settings'     => array(
	...
	'search_archive_item_title_font' => array(
		...
		'section'      => 'search_design',
		'label'        => esc_html__( 'Search Item Title Font', 'gadgeto' ),
		'default'      => thebase()->default( 'search_archive_item_title_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => 'body.search-results .loop-entry .entry-title',
				'property' => 'font',
				'key'      => 'typography',
			),
		),
	...
	'search_archive_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Search Results Background', 'gadgeto' ),
		),
	),
	'search_archive_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Search Results Content Background', 'gadgeto' ),
		),
	),
);
