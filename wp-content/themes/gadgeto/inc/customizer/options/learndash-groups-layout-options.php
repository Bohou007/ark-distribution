...
$settings = array(
	...
	'info_groups_title' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Group Title', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'groups_title' => array(
		...
		'label'        => esc_html__( 'Show Group Title?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'groups_title_layout' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'sfwd_groups_layout',
		'label'        => esc_html__( 'Group Title Layout', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 4,
	...
	'groups_title_align' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'sfwd_groups_layout',
		'label'        => esc_html__( 'Group Title Align', 'gadgeto' ),
		'priority'     => 4,
	...
	'groups_title_font' => array(
		...
		'section'      => 'sfwd_groups_layout_design',
		'label'        => esc_html__( 'Group Title Font', 'gadgeto' ),
	...
	'groups_title_background' => array(
		...
		'section'      => 'sfwd_groups_layout_design',
		'label'        => esc_html__( 'Group Above Area Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Group Title Background', 'gadgeto' ),
		),
	),
	...
	'info_sfwd_groups_layout' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Group Layout', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'groups_sidebar_id' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'label'        => esc_html__( 'Group Default Sidebar', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 10,
	...
	'groups_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Group Background', 'gadgeto' ),
		),
	),
	'groups_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Group Content Background', 'gadgeto' ),
		),
	),
);
