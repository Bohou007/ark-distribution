...
$settings = array(
	...
	'header_top_background' => array(
		...
		'section'      => 'header_top',
		'label'        => esc_html__( 'Top Row Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Top Row Background', 'gadgeto' ),
		),
	),
	...
	'header_top_trans_background' => array(
		'control_type' => 'thebase_background_control',
		'section'      => 'header_top',
		'label'        => esc_html__( '(When Transparent Header) Top Row Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Transparent Header Top Row Background', 'gadgeto' ),
		),
	),
