...
$settings = array(
	...
	'info_sfwd-topic_title' => array(
		...
		'section'      => 'sfwd_topic_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Topic Title', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'sfwd-topic_title' => array(
		...
		'label'        => esc_html__( 'Show Topic Title?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'sfwd-topic_title_layout' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'sfwd_topic_layout',
		'label'        => esc_html__( 'Topic Title Layout', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 4,
	...
	'sfwd-topic_title_align' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'sfwd_topic_layout',
		'label'        => esc_html__( 'Topic Title Align', 'gadgeto' ),
		'priority'     => 4,
	...
	'sfwd-topic_title_font' => array(
		...
		'section'      => 'sfwd_topic_layout_design',
		'label'        => esc_html__( 'Topic Title Font', 'gadgeto' ),
	...
	'sfwd-topic_title_background' => array(
		...
		'section'      => 'sfwd_topic_layout_design',
		'label'        => esc_html__( 'Topic Above Area Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Topic Title Background', 'gadgeto' ),
		),
	),
	...
	'info_sfwd-topic_layout' => array(
		...
		'section'      => 'sfwd_topic_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Topic Layout', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'sfwd-topic_sidebar_id' => array(
		...
		'section'      => 'sfwd_topic_layout',
		'label'        => esc_html__( 'Topic Default Sidebar', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 10,
	...
	'sfwd-topic_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Topic Background', 'gadgeto' ),
		),
	),
	'sfwd-topic_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Topic Content Background', 'gadgeto' ),
		),
	),
);
