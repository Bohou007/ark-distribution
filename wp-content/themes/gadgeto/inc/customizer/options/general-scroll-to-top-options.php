...
Theme_Customizer::add_settings(
	array(
		...
		'scroll_up' => array(
			...
			'label'        => esc_html__( 'Enable Scroll To Top', 'gadgeto' ),
			'transport'    => 'refresh',
		),
		'scroll_up_icon' => array(
			...
			'label'        => esc_html__( 'Scroll Up Icon', 'gadgeto' ),
			'partial'      => array(
		...
		'scroll_up_side' => array(
			...
			'label'        => esc_html__( 'Align', 'gadgeto' ),
			'context'      => array(
				array(
					'setting'  => 'scroll_up',
					'operator' => '==',
		...
		'scroll_up_side_offset' => array(
			'control_type' => 'thebase_range_control',
			'section'      => 'scroll_up',
			'label'        => esc_html__( 'Side Offset', 'gadgeto' ),
		...
		'scroll_up_bottom_offset' => array(
			'control_type' => 'thebase_range_control',
			'section'      => 'scroll_up',
			'label'        => esc_html__( 'Bottom Offset', 'gadgeto' ),
		...
		'scroll_up_visiblity' => array(
			...
			'label'        => esc_html__( 'Visibility', 'gadgeto' ),
			'context'      => array(
				array(
					'setting'  => 'scroll_up',
					'operator' => '==',
		...
		'scroll_up_style' => array(
			...
			'label'        => esc_html__( 'Scroll Button Style', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
					'selector' => '#tb-scroll-up-reader, #tb-scroll-up',
		...
		'scroll_up_padding' => array(
			...
			'label'        => esc_html__( 'Scroll Button Padding', 'gadgeto' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#tb-scroll-up-reader, #tb-scroll-up',
