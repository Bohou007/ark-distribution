...
<div class="thebase-compontent-custom fonts-flush-button wp-clearfix">
	<span class="customize-control-title">
		<?php esc_html_e( 'Flush Local Fonts Cache', 'gadgeto' ); ?>
	</span>
	<span class="description customize-control-description">
		<?php esc_html_e( 'Click the button to reset the local fonts cache', 'gadgeto' ); ?>
	</span>
	<input type="button" class="button thebase-flush-local-fonts-button" name="thebase-flush-local-fonts-button" value="<?php esc_attr_e( 'Flush Local Font Files', 'gadgeto' ); ?>" />
</div>
<?php
...
Theme_Customizer::add_settings(
	array(
		'enable_scroll_to_id' => array(
			...
			'label'        => esc_html__( 'Enable Scroll To ID', 'gadgeto' ),
		),
		'lightbox' => array(
			'control_type' => 'thebase_switch_control',
			'sanitize'     => 'thebase_sanitize_toggle',
			...
			'label'        => esc_html__( 'Enable Lightbox', 'gadgeto' ),
		),
		'load_fonts_local' => array(
			...
			'label'        => esc_html__( 'Load Google Fonts Locally', 'gadgeto' ),
		),
		'preload_fonts_local' => array(
			...
			'label'        => esc_html__( 'Preload Local Fonts', 'gadgeto' ),
			'context'      => array(
				array(
		...
		'enable_preload' => array(
			...
			'label'        => esc_html__( 'Enable CSS Preload', 'gadgeto' ),
		),
	)
);
