...
$settings = array(
	...
	'header_search_label' => array(
		...
		'label'        => esc_html__( 'Search Label', 'gadgeto' ),
		'context'      => array(
			array(
	...
	'header_search_label_visiblity' => array(
		...
		'label'        => esc_html__( 'Search Label Visibility', 'gadgeto' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'header_search_icon' => array(
		...
		'label'        => esc_html__( 'Search Icon', 'gadgeto' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'header_search_style' => array(
		...
		'label'        => esc_html__( 'Search Style', 'gadgeto' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_search_border' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Border', 'gadgeto' ),
	...
	'header_search_color' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Colors', 'gadgeto' ),
	...
	'header_search_background' => array(
		'control_type' => 'thebase_color_control',
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Background', 'gadgeto' ),
	...
	'header_search_padding' => array(
		...
		'label'        => esc_html__( 'Search Padding', 'gadgeto' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'info_search_modal' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Modal Options', 'gadgeto' ),
		'settings'     => false,
		'context'      => array(
			array(
				'setting' => '__current_tab',
	...
	'header_search_modal_color' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Text Colors', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'hover' => array(
					'tooltip' => __( 'Focus/Hover Color', 'gadgeto' ),
					'palette' => true,
				),
			),
		),
	...
	'header_search_modal_background' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Modal Background', 'gadgeto' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Modal Background', 'gadgeto' ),
		),
	),
);
	...
	$settings = array_merge(
		...
		array(
			'header_search_woo' => array(
				...
				'label'        => esc_html__( 'Search only Products?', 'gadgeto' ),
				'transport'    => 'refresh',
				'context'      => array(
					array(
						'setting' => '__current_tab',
