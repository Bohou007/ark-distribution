...
$settings = array(
	'info_llms_membership_title' => array(
		...
		'priority'     => 2,
		'label'        => esc_html__( 'Membership Title', 'gadgeto' ),
		'settings'     => false,
	),
	'llms_membership_title' => array(
		...
		'label'        => esc_html__( 'Show Membership Title?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'llms_membership_title_layout' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'llms_membership_layout',
		'label'        => esc_html__( 'Membership Title Layout', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 4,
	...
	'llms_membership_title_align' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'llms_membership_layout',
		'label'        => esc_html__( 'Membership Title Align', 'gadgeto' ),
		'priority'     => 4,
	...
	'info_llms_membership_layout' => array(
		...
		'section'      => 'llms_membership_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Membership Layout', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'llms_membership_sidebar_id' => array(
		...
		'section'      => 'llms_membership_layout',
		'label'        => esc_html__( 'Membership Default Sidebar', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 10,
