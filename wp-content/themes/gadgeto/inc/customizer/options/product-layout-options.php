...
$settings = array(
	...
	'info_product_title' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Product Above Content', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'product_above_layout' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 4,
		'default'      => thebase()->default( 'product_above_layout' ),
		'label'        => esc_html__( 'Above Content Layout', 'gadgeto' ),
		'transport'    => 'refresh',
		'input_attrs'  => array(
			'layout' => array(
				'title' => array(
					'tooltip' => __( 'Enables an Extra above content title area', 'gadgeto' ),
					'name'    => __( 'Extra Title Area', 'gadgeto' ),
					'icon'    => '',
				),
				'breadcrumbs' => array(
					'tooltip' => __( 'Enables Breadcrumbs', 'gadgeto' ),
					'name'    => __( 'Breadcrumbs', 'gadgeto' ),
					'icon'    => '',
				),
				'none' => array(
					'tooltip' => __( 'Hides this area', 'gadgeto' ),
					'name'    => __( 'Nothing', 'gadgeto' ),
					'icon'    => '',
				),
			),
			'responsive' => false,
	...
	'product_title_inner_layout' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 4,
		'default'      => thebase()->default( 'product_title_inner_layout' ),
	...
	'product_title_align' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'product_layout',
		'label'        => esc_html__( 'Product Above Align', 'gadgeto' ),
		'priority'     => 4,
		'default'      => thebase()->default( 'product_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'product_above_layout',
				'operator'   => '=',
	...
	'product_title_height' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 5,
		'label'        => esc_html__( 'Above Container Min Height', 'gadgeto' ),
		'context'      => array(
			array(
				'setting'    => 'product_above_layout',
				'operator'   => '=',
		...
		'default'      => thebase()->default( 'product_title_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'product_title_elements' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 6,
		'default'      => thebase()->default( 'product_title_elements' ),
		'label'        => esc_html__( 'Above Elements', 'gadgeto' ),
		'transport'    => 'refresh',
		'settings'     => array(
	...
	'product_above_title_font' => array(
		...
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Above Title Font', 'gadgeto' ),
		'default'      => thebase()->default( 'product_above_title_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'product_above_category_font' => array(
		'control_type' => 'thebase_typography_control',
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Above Category Font', 'gadgeto' ),
		'default'      => thebase()->default( 'product_above_category_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'product_title_breadcrumb_color' => array(
		...
		'default'      => thebase()->default( 'product_title_breadcrumb_color' ),
		'context'      => array(
			array(
				'setting'    => 'product_above_layout',
				'operator'   => '!=',
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.product-title .thebase-breadcrumbs',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '.product-title .thebase-breadcrumbs a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'product_title_breadcrumb_font' => array(
		...
		'default'      => thebase()->default( 'product_title_breadcrumb_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.product-title .thebase-breadcrumbs',
	...
	'product_title_background' => array(
		...
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Above Area Background', 'gadgeto' ),
		'default'      => thebase()->default( 'product_title_background' ),
		'context'      => array(
			array(
				'setting'    => 'product_above_layout',
				'operator'   => '=',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Product Above Title Background', 'gadgeto' ),
		),
	),
	'product_title_featured_image' => array(
		...
		'section'      => 'product_layout_design',
		'default'      => thebase()->default( 'product_title_featured_image' ),
	...
	'product_title_overlay_color' => array(
		...
		'default'      => thebase()->default( 'product_title_overlay_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'product_title_border' => array(
		...
		'default'      => thebase()->default( 'product_title_border' ),
		'context'      => array(
			array(
				'setting'    => 'product_above_layout',
				'operator'   => '=',
	...
	'info_product_layout' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Product Layout', 'gadgeto' ),
		'settings'     => false,
	),
	...
	'product_single_category_font' => array(
		'control_type' => 'thebase_typography_control',
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product In Content Category Font', 'gadgeto' ),
		'default'      => thebase()->default( 'product_single_category_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'product_title_font' => array(
		'control_type' => 'thebase_typography_control',
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Title Font', 'gadgeto' ),
		'default'      => thebase()->default( 'product_title_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'product_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thebase()->default( 'product_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'product_sidebar_id' => array(
		...
		'section'      => 'product_layout',
		'label'        => esc_html__( 'Product Default Sidebar', 'gadgeto' ),
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thebase()->default( 'product_sidebar_id' ),
		'input_attrs'  => array(
	...
	'product_content_style' => array(
		...
		'priority'     => 10,
		'default'      => thebase()->default( 'product_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'product_vertical_padding' => array(
		...
		'priority'     => 10,
		'default'      => thebase()->default( 'product_vertical_padding' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-product',
	...
	'product_content_elements' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'default'      => thebase()->default( 'product_content_elements' ),
		'label'        => esc_html__( 'Product Elements', 'gadgeto' ),
		'transport'    => 'refresh',
		'settings'     => array(
	...
	'custom_quantity' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'default'      => thebase()->default( 'custom_quantity' ),
		'label'        => esc_html__( 'Use Custom Quantity Plus and Minus', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'variation_direction' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'default'      => thebase()->default( 'variation_direction' ),
		'label'        => esc_html__( 'Product Variation Display', 'gadgeto' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-product',
		...
		'input_attrs'  => array(
			'layout' => array(
				'horizontal' => array(
					'name' => __( 'Horizontal', 'gadgeto' ),
				),
				'vertical' => array(
					'name' => __( 'Vertical', 'gadgeto' ),
				),
			),
			'responsive' => false,
		),
	...
	'product_tab_style' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'product_layout',
		'label'        => esc_html__( 'Tab Style', 'gadgeto' ),
		'priority'     => 10,
		'default'      => thebase()->default( 'product_tab_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-product',
	...
	'product_countdown' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'default'      => thebase()->default( 'product_countdown' ),
	...
	'product_tab_title' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'default'      => thebase()->default( 'product_tab_title' ),
		'label'        => esc_html__( 'Show default headings in tab content', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'product_additional_weight_dimensions' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'default'      => thebase()->default( 'product_additional_weight_dimensions' ),
		'label'        => esc_html__( 'Show Weight and Dimensions in Additional Information tab?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'product_related' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'default'      => thebase()->default( 'product_related' ),
		'label'        => esc_html__( 'Show Related Products?', 'gadgeto' ),
		'transport'    => 'refresh',
	),
	'product_related_columns' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Related Products Columns', 'gadgeto' ),
		'transport'    => 'refresh',
		'default'      => thebase()->default( 'product_related_columns' ),
		'context'      => array(
			array(
	...
	'product_background' => array(
		...
		'default'      => thebase()->default( 'product_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css_background',
				'selector' => 'body.single-product',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Product Background', 'gadgeto' ),
		),
	),
	'product_content_background' => array(
		...
		'default'      => thebase()->default( 'product_content_background' ),
		'live_method'  => array(
			array(
				'type'     => 'css_background',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Product Content Background', 'gadgeto' ),
		),
	),
);
