...
/**
 * Class TheBase_Control_Background
 *
 * @access public
 */
class TheBase_Control_Background extends WP_Customize_Media_Control {
	/**
	 * Control type
	 *
	 * @var string
	 */
	public $type = 'thebase_background_control';
...
$wp_customize->register_control_type( 'TheBase_Control_Background' );
