...
export const TheBaseColorPicker = ({ rgb, hex, hsv, hsl, onChange, renderers }) => {
  const styles = {
	picker: {
		width: 300,
		position: 'relative',
  ...
  return (
    <div style={ styles.picker } className={ 'thebase-picker' }>
...
export default CustomPicker(TheBaseColorPicker)