...
class AddComponent extends Component {
	...
	render() {
		...
		let classForAdd = 'thebase-builder-add-item';
		...
		return (
			<div className={ classForAdd } key={ this.props.id }>
				{ this.state.isVisible && (
					<Popover position="top" className="thebase-popover-add-builder" onClose={ toggleClose }>
						<div className="thebase-popover-builder-list">
				...
				<Button
					className="thebase-builder-item-add-icon"
					onClick={ () => {
