...
class RadioIconComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			include: {
				logo_only: {
					tooltip: __( 'Logo Only', 'gadgeto' ),
					name: __( 'Logo', 'gadgeto' ),
				},
				logo_title: {
					tooltip: __( 'Logo & Title', 'gadgeto' ),
					name: __( 'Logo & Title', 'gadgeto' ),
				},
				logo_title_tagline: {
					tooltip: __( 'Logo, Title & Tagline', 'gadgeto' ),
					name: __( 'Logo, Title & Tagline', 'gadgeto' ),
				},
			},
			layout: {
				logo_only: {
				...
				logo_title: {
					...
					title_logo: {
						tooltip: __( 'Title - Logo', 'gadgeto' ),
						icon: Icons.titleLogo
					},
					top_logo_title: {
						tooltip: __( 'Top Logo - Title', 'gadgeto' ),
						icon: Icons.topLogoTitle
					},
					top_title_logo: {
						tooltip: __( 'Top Title - Logo', 'gadgeto' ),
				...
				logo_title_tagline: {
					...
					title_tag_logo: {
						tooltip: __( 'Title - Tagline - Logo', 'gadgeto' ),
						icon: Icons.titleTagLogo
					},
					top_logo_title_tag: {
						tooltip: __( 'Top Logo - Title - Tagline', 'gadgeto' ),
						icon: Icons.topLogoTitleTag
					},
					top_title_tag_logo: {
						tooltip: __( 'Top Title - Tagline - Logo', 'gadgeto' ),
						icon: Icons.topTitleTagLogo
					},
					top_title_logo_tag: {
						tooltip: __( 'Top Title - Logo - Tagline', 'gadgeto' ),
	...
	render() {
		...
		return (
			<div className="thebase-control-field thebase-radio-icon-control">
				<ResponsiveControl
