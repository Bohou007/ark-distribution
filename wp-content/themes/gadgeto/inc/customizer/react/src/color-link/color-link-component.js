...
class ColorLinkComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			colors: {
				...
				'highlight-alt2': {
					tooltip: __( 'Text Alt', 'gadgeto' ),
					palette: true,
				},
			},
			styles: {
				'standard': {
					label: __( 'Standard (underline)', 'gadgeto' ),
				},
				'color-underline': {
					label: __( 'Highlight Underline', 'gadgeto' ),
				},
				'no-underline': {
					label: __( 'No Underline', 'gadgeto' ),
				},
				'hover-background': {
					label: __( 'Background on Hover', 'gadgeto' ),
				},
				'offset-background': {
					label: __( 'Offset Background', 'gadgeto' ),
				},
			},
		};
	...
	render() {
		...
		return (
			<Fragment>
				<div className="thebase-control-field thebase-color-control thebase-link-color-control">
					<span className="customize-control-title">
							{ __( 'Link Style', 'gadgeto' ) }
					</span>
					<SelectControl
