...
class BoxshadowComponent extends Component {
	...
	render() {
		...
		return (
			<div className="thebase-control-field thebase-boxshadow-control thebase-border-control">
				{ this.controlParams.responsive && (
					<ResponsiveControl
						onChange={ ( currentDevice) => this.setState( { currentDevice } ) }
						controlLabel={ responsiveControlLabel }
					>
						<div className="tb-box-color-settings tb-box-shadow-subset">
							<p className="tb-box-shadow-title">{ __( 'Color' ) }</p>
							<ColorControl
						...
						<div className="tb-box-x-settings tb-box-shadow-subset">
							<p className="tb-box-shadow-title">{ __( 'X' ) }</p>
							<div className="components-base-control tb-boxshadow-number-input">
						...
						<div className="tb-box-y-settings tb-box-shadow-subset">
							<p className="tb-box-shadow-title">{ __( 'Y' ) }</p>
							<div className="components-base-control tb-boxshadow-number-input">
								<div className="components-base-control__field">
									<input
						...
						<div className="tb-box-x-settings tb-box-shadow-subset">
							<p className="tb-box-shadow-title">{ __( 'Blur' ) }</p>
							<div className="components-base-control tb-boxshadow-number-input">
								<div className="components-base-control__field">
									<input
						...
						<div className="tb-box-y-settings tb-box-shadow-subset">
							<p className="tb-box-shadow-title">{ __( 'Spread' ) }</p>
							<div className="components-base-control tb-boxshadow-number-input">
								<div className="components-base-control__field">
									<input
						...
						<div className="tb-box-inset-settings">
							<ToggleControl
								label={ __( 'Inset' ) }
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						...
						<div className="thebase-responsive-controls-content">
							<Fragment>
								<div className="tb-box-color-settings tb-box-shadow-subset">
									<p className="tb-box-shadow-title">{ __( 'Color' ) }</p>
									<ColorControl
