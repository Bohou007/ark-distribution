...
class RadioIconComponent extends Component {
	...
	render() {
		...
		return (
			<div className={ `thebase-control-field thebase-radio-icon-control${ this.controlParams.class ? ' ' + this.controlParams.class : '' }` }>
									...
									<Fragment>
											...
											<Tooltip text={ this.controlParams.layout[ item ].tooltip }>
												<Button
													...
													className={ ( item === this.state.value[this.state.currentDevice] ?
															'active-radio ' :
															'' ) + 'tb-ratio-' + item + ( this.controlParams.layout[ item ].icon && this.controlParams.layout[ item ].name ? ' btn-flex-col' : '' ) }
													onClick={ () => {
														let value = this.state.value;
										...
										{ ! this.controlParams.layout[ item ].tooltip && (
											<Button
													...
													className={ ( item === this.state.value[this.state.currentDevice] ?
															'active-radio ' :
															'' ) + 'tb-radio-' + item + ( this.controlParams.layout[ item ].icon && this.controlParams.layout[ item ].name ? ' btn-flex-col' : '' ) }
															onClick={ () => {
																let value = this.state.value;
																value[ this.state.currentDevice ] = item;
																this.setState( value );
