...
class RowLayoutComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			desktop: {
				'column5': {
					'equal': {
						tooltip: __( 'Equal Width Columns', 'gadgeto' ),
						icon: 'fivecol',
					},
				},
				'column4': {
					...
					'left-forty': {
						tooltip: __( 'Left Heavy 40/20/20/20', 'gadgeto' ),
						icon: 'lfourforty',
					},
					'right-forty': {
						tooltip: __( 'Right Heavy 20/20/20/40', 'gadgeto' ),
						icon: 'rfourforty',
					},
				},
				'column3': {
					...
					'left-half': {
						tooltip: __( 'Left Heavy 50/25/25', 'gadgeto' ),
						icon: 'lefthalf',
					},
					'right-half': {
						tooltip: __( 'Right Heavy 25/25/50', 'gadgeto' ),
						icon: 'righthalf',
					},
					'center-half': {
						tooltip: __( 'Center Heavy 25/50/25', 'gadgeto' ),
						icon: 'centerhalf',
					},
					'center-wide': {
						tooltip: __( 'Wide Center 20/60/20', 'gadgeto' ),
						icon: 'widecenter',
					},
				},
				'column2': {
					...
					'left-golden': {
						tooltip: __( 'Left Heavy 66/33', 'gadgeto' ),
						icon: 'twoleftgolden',
					},
					'right-golden': {
						tooltip: __( 'Right Heavy 33/66', 'gadgeto' ),
						icon: 'tworightgolden',
					},
				},
				'column1': {
			...
			mobile: {
				'column5': {
					...
					'row': {
						tooltip: __( 'Collapse to Rows', 'gadgeto' ),
				...
				'column4': {
					...
					'two-grid': {
						tooltip: __( 'Two Column Grid', 'gadgeto' ),
						icon: 'grid',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'gadgeto' ),
				...
				'column3': {
					...
					'first-row': {
						tooltip: __( 'First Row, Next Columns 100 - 50/50', 'gadgeto' ),
						icon: 'firstrow',
					},
					'last-row': {
						tooltip: __( 'Last Row, Previous Columns 50/50 - 100', 'gadgeto' ),
						icon: 'lastrow',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'gadgeto' ),
	...
	render() {
		...
		return (
			<div className="thebase-control-field thebase-radio-icon-control thebase-row-layout-control">
											...
											<Tooltip text={ controlMap[ item ].tooltip }>
												...
												>
													...
													{ controlMap[ item ].dashicon && (
														<span className="thebase-radio-icon thebase-radio-dashicon">
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						<div className="thebase-responsive-control-bar">
	...
	linkColumns() {
		let self = this;
		document.addEventListener( 'thebaseUpdateFooterColumns', function( e ) {
