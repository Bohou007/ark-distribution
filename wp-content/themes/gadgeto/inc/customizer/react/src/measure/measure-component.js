...
class MeasureComponent extends Component {
	...
	render() {
		...
		return (
			<div className="thebase-control-field thebase-range-control">
				{ this.controlParams.responsive && (
					<ResponsiveControl
					...
					>
						...
						<div className="thebase-units thebase-locked">
							{ this.getResponsiveLockedButtons() }
						</div>
						{ this.controlParams.units && (
							<div className="thebase-units">
