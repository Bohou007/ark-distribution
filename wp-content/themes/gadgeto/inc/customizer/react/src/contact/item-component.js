			...
			<div className="thebase-sorter-item" data-id={ this.props.item.id } key={ this.props.item.id }>
				<div className="thebase-sorter-item-panel-header">
					...
					<span className="thebase-sorter-title">
						{ ( undefined !== this.props.item.label && '' !== this.props.item.label ? this.props.item.label : __( 'Contact Item', 'gadgeto' ) ) }
					</span>
				...
				{ this.state.open && (
					<div className="thebase-sorter-item-panel-content">
						<TabPanel className="sortable-style-tabs thebase-contact-type"
												...
												<Fragment>
													...
													{ this.props.item.url && (
														<div className="contact-custom-image">
															<div className="thebase-Contact-image">
																<img className="thebase-Contact-image-preview" src={ this.props.item.url } />
															</div>
															<Button
