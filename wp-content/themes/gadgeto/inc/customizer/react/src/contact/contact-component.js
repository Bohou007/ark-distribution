...
class ContactComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			...
			'options': [
				{ value: 'phone', label: __( 'Phone', 'gadgeto' ), content: __( '444-546-8765', 'gadgeto' ) },
				{ value: 'hours', label: __( 'Hours', 'gadgeto' ), content: __( 'Mon - Fri: 8AM - 5PM', 'gadgeto' ) },
				{ value: 'email', label: __( 'Email', 'gadgeto' ), content: __( 'example@example.com', 'gadgeto' ) },
				{ value: 'location', label: __( 'Address', 'gadgeto' ), content: __( '4560 example street', 'gadgeto' ) },
			],
		};
		...
		return (
			<div className="thebase-control-field thebase-sorter-items">
				...
				{ undefined !== availibleContactOptions[0] && undefined !== availibleContactOptions[0].value && (
					<div className="thebase-contact-add-area thebase-social-add-area">
						{ this.state.isVisible && (
							<Popover position="top right" className="thebase-popover-color thebase-popover-contact" onClose={ toggleClose }>
								<div className="thebase-popover-contact-list thebase-popover-social-list">
