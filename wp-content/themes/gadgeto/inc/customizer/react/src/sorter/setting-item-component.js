...
class ItemComponent extends Component {
	...
	render() {
		...
		if ( taxOptions ) {
			taxOptions = [{ label: __( 'Select', 'gadgeto' ), value: '' }].concat( taxOptions );
		}
		return (
			<div className="thebase-sorter-item" data-id={ this.props.item } key={ this.props.item }>
				<div className={ `thebase-sorter-item-panel-header ${ ( this.state.item.enabled ? 'panel-item-is-visible' : 'panel-item-is-hidden' ) }` }>
					{ this.props.moveable && ( 
						<span
					...
					<Tooltip text={ __( 'Toggle Item Visibility', 'gadgeto' ) }>
						<Button
							className={ `thebase-sorter-visiblity ${ ( this.state.item.enabled ? 'item-is-visible' : 'item-is-hidden' ) }`}
							onClick={ () => {
					...
					{ 'title' !== this.props.item && 'above_title' !== this.props.item && 'back_link' !== this.props.item && 'category' !== this.props.item && 'description' !== this.props.item && 'rating' !== this.props.item && 'product_meta' !== this.props.item && 'share' !== this.props.item && (
						<Tooltip text={ __( 'Expand Item Controls', 'gadgeto' ) }>
							<Button
					...
					<div className="thebase-sorter-item-panel-content">
						{ undefined !== this.state.item.ratio && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Set Image Ratio', 'gadgeto' ) }</span>
								<ButtonGroup className="thebase-radio-container-control thebase-featured-image-ratio">
						...
						{ undefined !== this.state.item.imageLink && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Image is link to post', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.show_title && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Post Title in Breadcrumb?', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.fullContent && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Full Content?', 'gadgeto' ) }
								...
								{ undefined !== this.state.item.words && false === this.state.item.fullContent && (
									<RangeControl
										...
										max={ 125 }
										step={ 1 }
										label={ __( 'Excerpt Word Count', 'gadgeto' ) }
									/>
								) }
							</div>
						) }
						{ undefined !== this.state.item.size && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Set Image Size', 'gadgeto' ) }</span>
								<SelectControl
						...
						{ undefined !== this.state.item.divider && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Divider', 'gadgeto' ) }</span>
						...
						{ undefined !== this.state.item.button_size && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose Button Size', 'gadgeto' ) }</span>
								<ButtonGroup className="thebase-radio-container-control">
						...
						{ undefined !== this.state.item.style && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Style', 'gadgeto' ) }</span>
								<ButtonGroup className="thebase-radio-container-control">
						...
						{ undefined !== this.state.item.taxonomy && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Taxonomy', 'gadgeto' ) }</span>
								<SelectControl
						...
						{ undefined !== this.state.item.show_shipping && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Shipping Statement?', 'gadgeto' ) }
									...
									<Fragment>
										{ undefined !== this.state.item.shipping_statement && (
											<div className="meta-label-control">
												<span className="sorter-control-title">{ __( 'Shipping Excerpt', 'gadgeto' ) }</span>
						...
						{ undefined !== this.state.item.feature_1 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'First Feature', 'gadgeto' ) }
									value={ this.state.item.feature_1 }
									onChange={ ( value ) => {
										this.updateValues( { feature_1: value } );
									} }
								/>
								<span className="sorter-control-title">{ __( 'Choose a Icon', 'gadgeto' ) }</span>
								<ButtonGroup className="thebase-radio-container-control">
						...
						{ undefined !== this.state.item.feature_2 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Second Feature', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.feature_3 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Third Feature', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.feature_4 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Fourth Feature', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.feature_5 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Fifth Feature', 'gadgeto' ) }
								...
								{ this.state.item.author && (
									<Fragment>
										{ undefined !== this.state.item.authorLink && (
											<Fragment>
												<ToggleControl
													label={ __( 'Enable Author Link?', 'gadgeto' ) }
										...
										{ undefined !== this.state.item.authorImage && (
											<Fragment>
												<ToggleControl
													label={ __( 'Show Author Image?', 'gadgeto' ) }
												...
												{ undefined !== this.state.item.authorImageSize && true === this.state.item.authorImage && (
													<RangeControl
														...
														max={ 125 }
														step={ 1 }
														label={ __( 'Author Image Size (px)', 'gadgeto' ) }
													/>
												) }
											</Fragment>
										) }
										{ undefined !== this.state.item.authorLabel && (
											<div className="meta-label-control">
												<span className="sorter-control-title">{ __( 'Author Label', 'gadgeto' ) }</span>
												<div className={ `meta-label-input-control ${ ( this.state.item.authorEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
													<Tooltip text={ __( 'Toggle Label Visibility', 'gadgeto' ) }>
														<Button
															className={ `thebase-label-visiblity ${ ( this.state.item.authorEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
															onClick={ () => {
						...
						{ undefined !== this.state.item.date && (
							<div className="sorter-sub-option">
								...
								{ undefined !== this.state.item.dateLabel && this.state.item.date && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Date Label', 'gadgeto' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.dateEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'gadgeto' ) }>
												<Button
													className={ `thebase-label-visiblity ${ ( this.state.item.dateEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Posted on', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.dateUpdated && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __(  'Show Last Updated Date?', 'gadgeto' ) }
								...
								{ undefined !== this.state.item.dateUpdatedLabel && this.state.item.dateUpdated && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Updated Date Label', 'gadgeto' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.dateUpdatedEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'gadgeto' ) }>
												<Button
													className={ `thebase-label-visiblity ${ ( this.state.item.dateUpdatedEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Updated on', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.categories && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __( 'Show Categories?', 'gadgeto' ) }
								...
								{ undefined !== this.state.item.categoriesLabel && this.state.item.categories && this.state.item.metaLabel && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Categories Label', 'gadgeto' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.categoriesEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'gadgeto' ) }>
												<Button
													className={ `thebase-label-visiblity ${ ( this.state.item.categoriesEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Posted in', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.comments && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __(  'Show Comments?', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.card_color && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose Icon Colors', 'gadgeto' ) }</span>
								<ButtonGroup className="thebase-radio-container-control">
						...
						{ undefined !== this.state.item.mastercard && (
							<ToggleControl
								label={ __(  'Show Mastercard?', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.discover && (
							<ToggleControl
								label={ __(  'Show Discover?', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.applepay && (
							<ToggleControl
								label={ __(  'Show Apple Pay?', 'gadgeto' ) }
						...
						{ undefined !== this.state.item.custom_enable_01 && (
							<Fragment>
								<ToggleControl
									label={ __(  'Show Custom 01?', 'gadgeto' ) }
										...
										{ this.state.item.custom_img_01 && (
											<div className="social-custom-image">
												<div className="thebase-social-image">
													<img className="thebase-social-image-preview" src={ this.state.item.custom_img_01 } />
												</div>
												<Button
						...
						{ undefined !== this.state.item.custom_enable_02 && (
							<Fragment>
								<ToggleControl
									label={ __(  'Show Custom 02?', 'gadgeto' ) }
								...
								{ this.state.item.custom_enable_02 && (
									<Fragment>
										...
										{ this.state.item.custom_img_02 && (
											<div className="social-custom-image">
												<div className="thebase-social-image">
													<img className="thebase-social-image-preview" src={ this.state.item.custom_img_02 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
								...
								{ this.state.item.custom_enable_03 && (
									<Fragment>
										...
										{ this.state.item.custom_img_03 && (
											<div className="social-custom-image">
												<div className="thebase-social-image">
													<img className="thebase-social-image-preview" src={ this.state.item.custom_img_03 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
								...
								{ this.state.item.custom_enable_04 && (
									<Fragment>
										...
										{ this.state.item.custom_img_04 && (
											<div className="social-custom-image">
												<div className="thebase-social-image">
													<img className="thebase-social-image-preview" src={ this.state.item.custom_img_04 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
								...
								{ this.state.item.custom_enable_05 && (
									<Fragment>
										...
										{ this.state.item.custom_img_05 && (
											<div className="social-custom-image">
												<div className="thebase-social-image">
													<img className="thebase-social-image-preview" src={ this.state.item.custom_img_05 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
