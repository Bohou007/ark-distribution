...
use TheBase_Control_Builder;
use TheBase_Control_Builder_Tabs;
use Customizer_Sanitize;
use WP_Customize_Control;
use LearnDash_Settings_Section;
use TheBase\WebFont_Loader;
...
class Theme_Customizer {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_thebase_flush_fonts_folder', array( $this, 'ajax_delete_fonts_folder' ) );
	...
	public function convert_beaver_custom_fonts() {
		$beaver_fonts = apply_filters( 'thebase_theme_add_custom_fonts', array() );
		if ( ! empty( $beaver_fonts ) && is_array( $beaver_fonts ) ) {
			add_filter(
				'thebase_theme_custom_fonts',
	...
	public function ajax_delete_fonts_folder() {
		// Check request.
		if ( ! check_ajax_referer( 'thebase-local-fonts-flush', 'nonce', false ) ) {
			wp_send_json_error( 'invalid_nonce' );
		}
		if ( ! current_user_can( 'edit_theme_options' ) ) {
			wp_send_json_error( 'invalid_permissions' );
		}
		if ( class_exists( '\TheBase\WebFont_Loader' ) ) {
			$font_loader = new \TheBase\WebFont_Loader( '' );
	...
	public function add_woocommerce_choices() {
		if ( class_exists( 'woocommerce' ) ) {
			...
			$options['cart'] = array(
				'name'    => esc_html__( 'Cart', 'gadgeto' ),
				'section' => 'thebase_customizer_cart',
			);
			...
			$options['mobile-cart'] = array(
				'name'    => esc_html__( 'Cart', 'gadgeto' ),
				'section' => 'thebase_customizer_mobile_cart',
			);
	...
	public function customizer_custom_widget_areas( $section_args, $section_id, $sidebar_id ) {
		if ( 'footer1' === $sidebar_id || 'footer2' === $sidebar_id || 'footer3' === $sidebar_id || 'footer4' === $sidebar_id || 'footer5' === $sidebar_id || 'footer6' === $sidebar_id ) {
			$section_args['panel'] = 'thebase_customizer_footer';
		}
		return $section_args;
	}
	/**
	...
	public function override_defaults( $wp_customize ) {
		 ...
		 * Move Site Identity
		 */
		$wp_customize->get_control( 'site_icon' )->section = 'thebase_customizer_site_identity';
		...
		if ( isset( $wp_customize->selective_refresh ) ) {
			...
			$wp_customize->selective_refresh->add_partial(
				...
				array(
					...
					'render_callback'     => 'TheBase\site_branding',
				)
			);
		}

		if ( ! empty( $opt_name_key = apply_filters( 'thebase_settings_key_custom_mapping', '', 'custom_logo' ) ) ) {
			...
			$wp_customize->add_setting(
				...
				array(
					...
					'default'           => isset( $setting['default'] ) && $control_class !== 'TheBase_Control_Background' ? $setting['default'] : '',
					'sanitize_callback' => array( 'TheBase\Customizer_Sanitize', 'thebase_sanitize_option' ),
				)
			);
		...
		self::$live_control['thebase_global_palette'] = $palette_live;
	...
	public function register_controls( $wp_customize ) {
		...
		require_once $path . 'class-thebase-control-blank.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-color.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-range.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-switch.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-radio-icon.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-multi-radio-icon.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-builder.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-available.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-color-palette.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-background.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-border.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-borders.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-typography.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-title.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-focus-button.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-color-link.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-text.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-measure.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-editor.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-sorter.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-social.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-contact.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-check-icon.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-select.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-row.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-tab.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		require_once $react_path . 'class-thebase-control-shadow.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
	}
	...
	public static function get_panels() {
		...
		if ( is_null( self::$panels ) ) {
			$panels = array(
				'general' => array(
					'title'    => __( 'General', 'gadgeto' ),
					'priority' => 18,
				),
				'header' => array(
					'title'    => __( 'Header', 'gadgeto' ),
					'priority' => 20,
				),
				'footer' => array(
					'title'    => __( 'Footer', 'gadgeto' ),
					'priority' => 22,
				),
				'blog_posts' => array(
					'title'    => __( 'Blog Posts', 'gadgeto' ),
					'priority' => 23,
				),
				'custom_post' => array(
					'title'    => __( 'Custom Post Types', 'gadgeto' ),
					'priority' => 24,
				),
			);
			if ( class_exists( 'SFWD_LMS' ) ) {
				$extra_learn['learndash'] = array(
					'title'    => __( 'LearnDash', 'gadgeto' ),
					'priority' => 25,
				);
				$panels = array_merge(
					$panels,
	...
	public static function get_sections() {
		...
		if ( is_null( self::$sections ) ) {
			$sections = array(
				'site_identity' => array(
					'title'    => __( 'Site Identity', 'gadgeto' ),
					'priority' => 25,
				),
				'general_layout' => array(
					'title'    => __( 'Layout', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 7,
				),
				'sidebar' => array(
					'title'    => __( 'Sidebar', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 8,
				),
				'sidebar_design' => array(
					'title'    => __( 'Sidebar Design', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 8,
				),
				'general_colors' => array(
					'title'    => __( 'Colors', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 9,
				),
				'general_buttons' => array(
					'title'    => __( 'Buttons', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 10,
				),
				...
				'scroll_up' => array(
					'title'    => __( 'Scroll To Top', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 12,
				),
				...
				'general_social' => array(
					'title'    => __( 'Social Links', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				'general_comments' => array(
					'title'    => __( 'Comments', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				'general_performance' => array(
					'title'    => __( 'Performance', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 21,
				),
				'breadcrumbs' => array(
					'title'    => __( 'Breadcrumbs', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				'general_404' => array(
					'title'    => __( '404 Page Layout', 'gadgeto' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				...
				'header_builder' => array(
					'title'    => __( 'Header Builder', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 9,
				),
				'header_top' => array(
					'title'    => __( 'Top Row', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				'header_main' => array(
					'title'    => __( 'Main Row', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				'header_bottom' => array(
					'title'    => __( 'Bottom Row', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				'header_popup' => array(
					'title'    => __( 'Header Off Canvas', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				...
				'primary_navigation' => array(
					'title'    => __( 'Primary Navigation', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'secondary_navigation' => array(
					'title'    => __( 'Secondary Navigation', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'dropdown_navigation' => array(
					'title'    => __( 'Dropdown Navigation', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'mobile_trigger' => array(
					'title'    => __( 'Mobile Trigger', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'mobile_navigation' => array(
					'title'    => __( 'Mobile Navigation', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'mobile_button' => array(
					'title'    => __( 'Header Mobile Button', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'mobile_html' => array(
					'title'    => __( 'Header Mobile HTML', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'header_html' => array(
					'title'    => __( 'HTML Editor', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'cart' => array(
					'title'    => __( 'Header Cart', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'cart_design' => array(
					'title'    => __( 'Header Cart Design', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'mobile_cart' => array(
					'title'    => __( 'Mobile Header Cart', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_button' => array(
					'title'    => __( 'Header Button', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_social' => array(
					'title'    => __( 'Header Social', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_search' => array(
					'title'    => __( 'Header Search', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'transparent_header' => array(
					'title'    => __( 'Transparent Header', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_sticky' => array(
					'title'    => __( 'Sticky Header', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'footer_builder' => array(
					'title'    => __( 'Footer Builder', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 9,
				),
				'footer_top' => array(
					'title'    => __( 'Footer Top', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_middle' => array(
					'title'    => __( 'Footer Middle', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_bottom' => array(
					'title'    => __( 'Footer Bottom', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_html' => array(
					'title'    => __( 'Footer Copyright HTML', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				'footer_social' => array(
					'title'    => __( 'Footer Social', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_navigation' => array(
					'title'    => __( 'Footer Navigation', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				'page_layout' => array(
				...
				'search' => array(
					'title'    => __( 'Search Results', 'gadgeto' ),
					'priority' => 24,
				),
				'search_design' => array(
					'title'    => __( 'Search Results', 'gadgeto' ),
				...
				'post_layout' => array(
					'title'    => __( 'Single Post Layout', 'gadgeto' ),
					'panel'    => 'blog_posts',
					'priority' => 24,
				),
				...
				'post_archive' => array(
					'title'    => __( 'Archive Layout', 'gadgeto' ),
					'panel'    => 'blog_posts',
					'priority' => 25,
				),
			...
			if ( ( defined( 'GUTENBERG_VERSION' ) && version_compare( GUTENBERG_VERSION, '10.6.2', '>' ) ) || version_compare( substr( get_bloginfo( 'version' ), 0, 3 ), '5.8', '>=' ) ) {
				$blocks_extra['sidebar-widgets-footer1'] = array(
					'title'    => __( 'Widget Footer 1 Settings', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer2'] = array(
					'title'    => __( 'Widget Footer 2 Settings', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer3'] = array(
					'title'    => __( 'Widget Footer 3 Settings', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer4'] = array(
					'title'    => __( 'Widget Footer 4 Settings', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer5'] = array(
					'title'    => __( 'Widget Footer 5 Settings', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer6'] = array(
					'title'    => __( 'Widget Footer 6 Settings', 'gadgeto' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-header1'] = array(
					'title'    => __( 'Widget Header Settings', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-header2'] = array(
					'title'    => __( 'Widget Area Settings', 'gadgeto' ),
					'panel'    => 'header',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-product-filter'] = array(
					'title'    => __( 'Catalog Off Canvas Sidebar Settings', 'gadgeto' ),
					'panel'    => 'woocommerce',
					'priority' => 18,
				);
			...
			if ( class_exists( 'woocommerce' ) ) {
				$extra_woo['woocommerce_product_catalog'] = array(
					'title'    => __( 'Product Catalog', 'gadgeto' ),
					'panel'    => 'woocommerce',
					'priority' => 10,
				);
				...
				$extra_woo['product_layout'] = array(
					'title'    => __( 'Single Product Layout', 'gadgeto' ),
					'panel'    => 'woocommerce',
					'priority' => 10,
				);
				...
				$extra_woo['account_layout'] = array(
					'title'    => __( 'My Account Layout', 'gadgeto' ),
					'panel'    => 'woocommerce',
					'priority' => 24,
				);
				$extra_woo['woocommerce_store_notice_design'] = array(
					'title'    => __( 'Store Notice', 'gadgeto' ),
					'panel'    => 'woocommerce',
					'priority' => 10,
				);
				$sections = array_merge(
			...
			if ( class_exists( 'SFWD_LMS' ) ) {
				...
				$extra_learn['sfwd_courses_layout'] = array(
					'title'    => __( 'Course Layout', 'gadgeto' ),
					'panel'    => 'learndash',
					'priority' => 10,
				);
				...
				$extra_learn['sfwd_courses_archive_layout'] = array(
					'title'    => __( 'Course Archive Layout', 'gadgeto' ),
					'panel'    => 'learndash',
					'priority' => 11,
				);
				...
				$extra_learn['sfwd_lesson_layout'] = array(
					'title'    => __( 'Lesson Layout', 'gadgeto' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
				...
				$extra_learn['sfwd_groups_layout'] = array(
					'title'    => __( 'Groups Layout', 'gadgeto' ),
					'panel'    => 'learndash',
					'priority' => 11,
				);
				...
				$extra_learn['sfwd_design'] = array(
					'title'    => __( 'Learn Dash Design', 'gadgeto' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
				$extra_learn['sfwd_grid_layout'] = array(
					'title'    => __( 'Course Grid Design', 'gadgeto' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
			...
			if ( class_exists( 'BBPress' ) ) {
				...
				$extra_bbpress['forum_archive'] = array(
					'title'    => __( 'Forum Archive', 'gadgeto' ),
					'panel'    => 'bbpress',
					'priority' => 10,
				);
			...
			if ( class_exists( 'LifterLMS' ) ) {
				...
				$extra_lifter['course_archive'] = array(
					'title'    => __( 'Course Archive', 'gadgeto' ),
					'panel'    => 'lifterlms',
					'priority' => 11,
				);
				...
				$extra_lifter['llms_membership_layout'] = array(
					'title'    => __( 'Membership Layout', 'gadgeto' ),
					'panel'    => 'lifterlms',
					'priority' => 14,
				);
				$extra_lifter['llms_membership_archive'] = array(
					'title'    => __( 'Membership Archive', 'gadgeto' ),
					'panel'    => 'lifterlms',
					'priority' => 15,
				);
				...
				$extra_lifter['llms_dashboard_layout'] = array(
					'title'    => __( 'User Dashboard', 'gadgeto' ),
					'panel'    => 'lifterlms',
					'priority' => 16,
				);
				$sections = array_merge(
			...
			if ( defined( 'TRIBE_EVENTS_FILE' ) ) {
				$extra_events['tribe_events_layout'] = array(
					'title'    => __( 'Single Event Layout', 'gadgeto' ),
				...
				$extra_events['tribe_events_archive'] = array(
					'title'    => __( 'Events Layout', 'gadgeto' ),
					'panel'    => 'tribe_customizer',
					'priority' => 85,
				);
				$sections = array_merge(
			...
			$post_types        = thebase()->get_post_types_objects();
			...
			foreach ( $post_types as $post_type_item ) {
				...
				if ( ! in_array( $post_type_name, $ignore_type, true ) ) {
					...
					$extras_post_types[ $post_type_name . '_layout' ] = array(
						'title'    => $post_type_label . ' ' . __( 'Layout', 'gadgeto' ),
						'panel'    => 'custom_post',
						'priority' => 10,
					);
					...
					$extras_post_types[ $post_type_name . '_archive' ] = array(
						'title'    => $post_type_label . ' ' . __( 'Archive', 'gadgeto' ),
						'panel'    => 'custom_post',
						'priority' => 10,
					);
			...
			self::$sections = apply_filters( 'thebase_theme_customizer_sections', $final_sections );
		}
		// Return sections.
	...
	public static function get_capability() {
		...
		if ( is_null( self::$capability ) ) {
			self::$capability = apply_filters( 'thebase_theme_customizer_capability', 'manage_options' );
		}
		// Return capability.
	...
	public function register_settings( $wp_customize ) {
		...
		foreach ( self::$settings as $setting_key => $setting ) {
			...
			if ( isset( $setting['control_type'] ) && ! empty( $setting['control_type'] ) ) {
				if ( substr( $setting['control_type'], 0, 8 ) === 'thebase_' ) {
					$control_class = 'TheBase_Control_' . ucfirst( str_replace( 'thebase_', '', str_replace( '_control', '', $setting['control_type'] ) ) );
				} else {
			...
			if ( isset( $setting['sanitize'] ) && ! empty( $setting['sanitize'] ) ) {
				if ( substr( $setting['sanitize'], 0, 8 ) === 'thebase_' ) {
					$sanitize_function = array( 'TheBase\Customizer_Sanitize', $setting['sanitize'] );
				} else {
					$sanitize_function = $setting['sanitize'];
				}
			} else {
				$sanitize_function = array( 'TheBase\Customizer_Sanitize', 'thebase_sanitize_option' );
				$sanitize_function = '';
			}
			if ( 'option' === thebase()->get_option_type() ) {
				$setting_key = thebase()->get_option_name() . '[' . $setting_key . ']';
			}
			if ( ! empty( $opt_name_key = apply_filters( 'thebase_settings_key_custom_mapping', '', $setting_key ) ) ) {
			...
			if ( ! in_array( $section_key, self::$sections_added, true ) ) {
				...
				if ( ( defined( 'GUTENBERG_VERSION' ) && version_compare( GUTENBERG_VERSION, '10.6.2', '>' ) ) || version_compare( substr( get_bloginfo( 'version' ), 0, 3 ), '5.8', '>=' ) ) {
					if ( 'sidebar-widgets-footer1' === $section_key || 'sidebar-widgets-footer2' === $section_key || 'sidebar-widgets-footer3' === $section_key || 'sidebar-widgets-footer4' === $section_key || 'sidebar-widgets-footer5' === $section_key || 'sidebar-widgets-footer6' === $section_key || 'sidebar-widgets-header1' === $section_key || 'sidebar-widgets-header2' === $section_key || 'sidebar-widgets-product-filter' === $section_key ) {
						$section_id = 'thebase_customizer_' . $section_key;
					}
				}
				// Register section.
	...
	public static function maybe_add_panel( $wp_customize, $child ) {
		...
		if ( ! empty( $child['panel'] ) && isset( $panels[ $child['panel'] ] ) ) {
			...
			if ( ! in_array( $panel_key, self::$panels_added, true ) ) {
				...
				// Register panel.
				$wp_customize->add_panel( 'thebase_customizer_' . $panel_key, $panel_config );
		...
		foreach ( self::$settings as $setting_key => $setting ) {
			...
			if ( ! empty( $setting['section'] ) ) {
				...
				if ( ( defined( 'GUTENBERG_VERSION' ) && version_compare( GUTENBERG_VERSION, '10.6.2', '>' ) ) || version_compare( substr( get_bloginfo( 'version' ), 0, 3 ), '5.8', '>=' ) ) {
					if ( 'sidebar-widgets-footer1' === $setting['section'] || 'sidebar-widgets-footer2' === $setting['section'] || 'sidebar-widgets-footer3' === $setting['section'] || 'sidebar-widgets-footer4' === $setting['section'] || 'sidebar-widgets-footer5' === $setting['section'] || 'sidebar-widgets-footer6' === $setting['section'] || 'sidebar-widgets-header1' === $setting['section'] || 'sidebar-widgets-header2' === $setting['section'] || 'sidebar-widgets-product-filter' === $setting['section'] ) {
						$control_config['section'] = 'thebase_customizer_' . $setting['section'];
					}
				}
			}
			...
			if ( ! empty( $setting['panel'] ) ) {
				if ( 'woocommerce' === $control_config['panel'] ) {
					...
					$control_config['panel'] = 'thebase_customizer_' . $setting['panel'];
				}
			}
	...
	public static function active_callback( $object ) {
		if ( ! isset( $object->setting->id ) && 'thebase_builder_control' !== $object->type ) {
			return true;
		}
		if ( 'thebase_builder_control' === $object->type ) {
			$id = str_replace( thebase()->get_option_name() . '_', '', $object->id );
		} else {
		...
		if ( ! isset( $settings[ $id ]['active_callback'][0] ) && 3 === count( $settings[ $id ]['active_callback'] ) ) {
			...
			$field_value = thebase()->option( $field_id );
	...
	public static function get_builder_choices() {
		return apply_filters( 'thebase_theme_customizer_control_choices', self::$choices );
	}
	/**
	...
	public function enqueue_customizer_scripts() {
		...
		if ( isset( $_GET['wpum_email_customizer'] ) || apply_filters( 'prevent_thebase_customizer_scripts', false ) ) {
			return;
		}
		...
		wp_enqueue_style( 'thebase-customizer-styles', $path . 'css/thebase-customizer.css', false, gadgeto_VERSION );
		if ( is_rtl() ) {
			wp_enqueue_style( 'thebase-customizer-rtl', $path . 'css/rtl-thebase-customizer.css', false, gadgeto_VERSION );
		}
		...
		wp_enqueue_script( 'customizer-text-widgets', get_template_directory_uri() . '/assets/js/text-widgets.min.js', array( 'jquery', 'backbone', 'editor', 'wp-util', 'wp-a11y', 'text-widgets' ), gadgeto_VERSION, false );
		wp_enqueue_script( 'thebase-customizer-controls', get_template_directory_uri() . '/assets/js/customizer.js', $editor_dependencies, gadgeto_VERSION, true );
		wp_enqueue_style( 'thebase-customizer-controls', $path . 'react/build/controls.css', array( 'wp-components' ), gadgeto_VERSION );
		wp_localize_script(
			'thebase-customizer-controls',
			'thebaseCustomizerControlsData',
			array(
				'contexts'           => self::get_control_contexts(),
				'choices'            => self::get_builder_choices(),
				'palette'            => thebase()->get_palette_for_customizer(),
				'gfontvars'          => $google_font_variants,
				'cfontvars'          => apply_filters( 'thebase_theme_custom_fonts', array() ),
				'palettePresets'     => apply_filters( 'thebase_theme_palette_presets', $palette_presets ),
				'flushFonts'         => wp_create_nonce( 'thebase-local-fonts-flush' ),
				'fontPairs'          => apply_filters( 'thebase_font_pairs_array', $fonts ),
				'source'             => apply_filters( 'thebase_settings_extra_source', false ),
		...
		$css = ':root {
			--global-palette1: ' . thebase()->palette_option( 'palette1' ) . ';
			--global-palette2: ' . thebase()->palette_option( 'palette2' ) . ';
			--global-palette3: ' . thebase()->palette_option( 'palette3' ) . ';
			--global-palette4: ' . thebase()->palette_option( 'palette4' ) . ';
			--global-palette5: ' . thebase()->palette_option( 'palette5' ) . ';
			--global-palette6: ' . thebase()->palette_option( 'palette6' ) . ';
			--global-palette7: ' . thebase()->palette_option( 'palette7' ) . ';
			--global-palette8: ' . thebase()->palette_option( 'palette8' ) . ';
			--global-palette9: ' . thebase()->palette_option( 'palette9' ) . ';
			--global-palette-highlight: ' . $this->render_color( thebase()->sub_option( 'link_color', 'highlight' ) ) . ';
			--global-palette-highlight-alt: ' . $this->render_color( thebase()->sub_option( 'link_color', 'highlight-alt' ) ) . ';
			--global-palette-highlight-alt2: ' . $this->render_color( thebase()->sub_option( 'link_color', 'highlight-alt2' ) ) . ';
			--global-palette-btn: ' . $this->render_color( thebase()->sub_option( 'buttons_color', 'color' ) ) . ';
			--global-palette-btn-hover: ' . $this->render_color( thebase()->sub_option( 'buttons_color', 'hover' ) ) . ';
			--global-palette-btn-bg: ' . $this->render_color( thebase()->sub_option( 'buttons_background', 'color' ) ) . ';
			--global-palette-btn-bg-hover: ' . $this->render_color( thebase()->sub_option( 'buttons_background', 'hover' ) ) . ';
			--global-base-font: ' . thebase()->sub_option( 'base_font', 'family' ) . ';
			--global-heading-font: ' . ( 'inherit' !== thebase()->sub_option( 'heading_font', 'family' ) ? thebase()->sub_option( 'heading_font', 'family' ) : 'var(--global-base-font)' ) . ';
		}';
		wp_add_inline_style( 'thebase-customizer-controls', wp_strip_all_tags( $css ) );
	}
	/**
	...
	public function action_enqueue_customize_preview_scripts() {
		$path = get_template_directory_uri() . '/inc/customizer/';
		wp_enqueue_style( 'thebase-customizer-preview', $path . 'css/thebase-customizer-preview.css', false, gadgeto_VERSION );
		wp_enqueue_script( 'thebase-customizer-preview', $path . 'js/thebase-customizer-preview.min.js', array( 'customize-preview' ), gadgeto_VERSION, true );
		wp_localize_script(
			'thebase-customizer-preview',
			'thebaseCustomizerPreviewData',
			array(
	...
	public static function get_control_contexts() {
		// Return contexts.
		return apply_filters( 'thebase_theme_customizer_control_contexts', self::$contexts );
	}
	...
	public static function get_live_control_data() {
		// Return contexts.
		return apply_filters( 'thebase_theme_customizer_live_control_data', self::$live_control );
	}
