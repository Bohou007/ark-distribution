...
class TheBaseThemeLayout extends Component {
	constructor() {
		super( ...arguments );
		this.state = {
		};
	...
	render() {
		const selectOptions = Object.keys( thebaseMetaParams.sidebars ).map( ( item ) => {
			return ( { label: thebaseMetaParams.sidebars[ item ].label, value: thebaseMetaParams.sidebars[ item ].value } );
		} );
		...
		const titleOptions = {
			'default': {
				tooltip: __( 'Inherited Default', 'gadgeto' ),
				icon: 'inherit',
			},
			'hide': {
				tooltip: __( 'Hide Title', 'gadgeto' ),
				icon: 'hidetitle',
			},
			'normal': {
				tooltip: __( 'Show In Content', 'gadgeto' ),
				icon: 'incontent',
			},
			'above': {
				tooltip : __( 'Show Above Content', 'gadgeto' ),
				icon: 'abovecontent',
			},
		}
		...
		return (
			<Fragment>
				<PluginSidebarMoreMenuItem
					...
					icon={ icon }
				>
					{ thebaseMetaParams.post_type_name + ' ' + __( 'Settings', 'gadgeto' ) }
				</PluginSidebarMoreMenuItem>
				<PluginSidebar
					isPinnable={ true }
					icon={ icon }
					name="theme-meta-panel"
					title={ thebaseMetaParams.post_type_name + ' ' + __( 'Settings', 'gadgeto' ) }
				>
					<div className="thebase-sidebar-container components-panel__body is-opened">
						<RadioIconComponent
							label={ __( 'Transparent Header' ) }
							value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_transparent && '' !== this.props.meta._tbt_post_transparent ? this.props.meta._tbt_post_transparent : 'default' ) }
							customClass="three-col-short"
							options={ transparentOptions }
							onChange={ value => {
								this.props.setMetaFieldValue( value, '_tbt_post_transparent' );
							} }
						/>
						<RadioIconComponent
							label={ thebaseMetaParams.post_type_name + ' ' + __( 'Title' ) }
							customClass="three-col-short"
							value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_title && '' !== this.props.meta._tbt_post_title ? this.props.meta._tbt_post_title : 'default' ) }
							options={ newTitleOptions }
							onChange={ value => {
								let title = value;
								if( 'default' === value ) {
									title = thebaseMetaParams.title;
								} else if ( 'show' === value ) {
									title = thebaseMetaParams.title_position;
								}
								...
								this.props.setMetaFieldValue( value, '_tbt_post_title' );
							} }
						/>
						<RadioIconComponent
							label={ thebaseMetaParams.post_type_name + ' ' + __( 'Layout' ) }
							customClass="three-col-square"
							value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_layout && '' !== this.props.meta._tbt_post_layout ? this.props.meta._tbt_post_layout : 'default' ) }
							...
							onChange={ value => {
								...
								if ( 'left' === value || 'right' === value ) {
									...
									layout = thebaseMetaParams.layout;
									sidebar = thebaseMetaParams.sidebar;
								}
								...
								this.props.setMetaFieldValue( value, '_tbt_post_layout' );
							} }
						/>
						{ ( ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_layout && '' !== this.props.meta._tbt_post_layout && ( 'left' === this.props.meta._tbt_post_layout || 'right' === this.props.meta._tbt_post_layout ) ) || ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_layout && 'default' === this.props.meta._tbt_post_layout && ( 'left' === thebaseMetaParams.sidebar || 'right' === thebaseMetaParams.sidebar ) ) || ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_layout && '' === this.props.meta._tbt_post_layout && ( 'left' === thebaseMetaParams.sidebar || 'right' === thebaseMetaParams.sidebar ) ) ) && (
							<div className="thebase-control-field thebase-select-control">
								<div className="thebase-title-control-bar">
									<span className="customize-control-title">{ capitalizeFirstLetter( thebaseMetaParams.post_type ) + ' ' + __( 'sidebar' )  }</span>
								</div>
								<SelectControl
									value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_sidebar_id && '' !== this.props.meta._tbt_post_sidebar_id ? this.props.meta._tbt_post_sidebar_id : 'default' ) }
									options={ selectOptions }
									onChange={ ( val ) => {
										this.props.setMetaFieldValue( val, '_tbt_post_sidebar_id' );
									} }
								/>
							</div>
						) }
						<RadioIconComponent
							...
							value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_content_style && '' !== this.props.meta._tbt_post_content_style ? this.props.meta._tbt_post_content_style : 'default' ) }
							customClass="three-col-short"
							options={ boxedOptions }
							onChange={ value => {
								let boxed = value;
								if( 'default' === value ) {
									boxed = thebaseMetaParams.boxed;
								}
								...
								this.props.setMetaFieldValue( value, '_tbt_post_content_style' );
							} }
						/>
						<RadioIconComponent
							label={ __( 'Content Vertical Padding' ) }
							value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_vertical_padding && '' !== this.props.meta._tbt_post_vertical_padding ? this.props.meta._tbt_post_vertical_padding : 'default' ) }
							options={ paddingOptions }
							customClass="three-col-short"
							onChange={ value => {
								let padding = value;
								if( 'default' === value ) {
									padding = thebaseMetaParams.vpadding;
								}
								...
								document.body.classList.remove( 'post-content-vertical-padding-block-start' );
								document.body.classList.remove( 'post-content-vertical-padding-block-end' );
								document.body.classList.add( 'post-content-vertical-padding-' + padding );
								this.props.setMetaFieldValue( value, '_tbt_post_vertical_padding' );
							} }
						/>
						{ thebaseMetaParams.supports_feature && (
							<Fragment>
								<RadioIconComponent
									label={ __( 'Show Featured Image' ) }
									value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_feature && '' !== this.props.meta._tbt_post_feature ? this.props.meta._tbt_post_feature : 'default' ) }
									options={ featuredOptions }
									customClass="three-col-short"
									onChange={ value => {
										this.props.setMetaFieldValue( value, '_tbt_post_feature' );
									} }
								/>
								{ ( ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_feature && 'show' === this.props.meta._tbt_post_feature ) || ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_feature && 'default' === this.props.meta._tbt_post_feature && 'show' === thebaseMetaParams.feature ) || ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_feature && '' === this.props.meta._tbt_post_feature && 'show' === thebaseMetaParams.feature ) ) && (
									<RadioIconComponent
										label={ __( 'Featured Image Position' ) }
										value={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_feature_position && '' !== this.props.meta._tbt_post_feature_position ? this.props.meta._tbt_post_feature_position : 'default' ) }
										options={ featuredPositionOptions }
										customClass="two-col-short"
										onChange={ value => {
											this.props.setMetaFieldValue( value, '_tbt_post_feature_position' );
										} }
									/>
								) }
							</Fragment>
						...
						<ToggleControl
							...
							checked={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_header && '' !== this.props.meta._tbt_post_header ? this.props.meta._tbt_post_header : false ) }
							onChange={ ( value ) => {
								this.props.setMetaFieldValue( value, '_tbt_post_header' );
							} }
						/>
						<ToggleControl
							label={ __( 'Disable Footer' ) }
							checked={ ( undefined !== this.props.meta && undefined !== this.props.meta._tbt_post_footer && '' !== this.props.meta._tbt_post_footer ? this.props.meta._tbt_post_footer : false ) }
							onChange={ ( value ) => {
								this.props.setMetaFieldValue( value, '_tbt_post_footer' );
							} }
						/>
					</div>
				</PluginSidebar>
