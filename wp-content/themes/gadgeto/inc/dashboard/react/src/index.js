...
class TheBaseDashboard extends Component {
	render() {
		const tabs = [
			{
				name: 'dashboard',
				title: __( 'Dashboard', 'gadgeto' ),
				className: 'thebase-dash-tab',
			},
			{
				name: 'help',
				title: __( 'Getting Started', 'gadgeto' ),
				className: 'thebase-help-tab',
			},
			{
				name: 'changelog',
				title: __( 'Changelog', 'gadgeto' ),
				className: 'thebase-changelog-tab',
			},
			// {
			// 	name: 'recommended',
			// 	title: __( 'Recommended Plugins', 'gadgeto' ),
			// 	className: 'thebase-recommended-tab',
			// },
			{
				name: 'starter',
				title: __( 'Starter Templates', 'gadgeto' ),
